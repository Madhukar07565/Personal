 ...
 */
package com.cnk.travelogix.ccintegrationfacade.jalo;
...
import com.cnk.travelogix.ccintegrationfacade.constants.CcintegrationfacadeConstants;



/**
 * This is the extension manager of the Ccintegrationfacade extension.
 */
public class CcintegrationfacadeManager extends GeneratedCcintegrationfacadeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CcintegrationfacadeManager.class.getName());
	 ...
	 */
	public static CcintegrationfacadeManager getInstance()
	{
		return (CcintegrationfacadeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CcintegrationfacadeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CcintegrationfacadeManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CcintegrationfacadeManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CcintegrationfacadeManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CcintegrationfacadeManager called, current tenant: " + getTenant().getTenantID());
		}
	}
