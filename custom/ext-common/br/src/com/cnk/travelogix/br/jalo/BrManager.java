 ...
 */
package com.cnk.travelogix.br.jalo;
...
import com.cnk.travelogix.br.constants.BrConstants;



/**
 * This is the extension manager of the Br extension.
 */
public class BrManager extends GeneratedBrManager
{
	...
	{
		return (BrManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				BrConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public BrManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of BrManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of BrManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of BrManager called, current tenant: " + getTenant().getTenantID());
		}
	}
