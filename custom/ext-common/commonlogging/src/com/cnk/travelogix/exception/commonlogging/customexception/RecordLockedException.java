...
{
	public static final String ERROR_CODE = "ERROR013";
	 ...
	 * @param message
	 */
	public RecordLockedException(final String code, final String message)
	{
		super(code, message);
	}
	 ...
	 * @param message
	 */
	public RecordLockedException(final String code, final String handlingCode, final String message)
	{
