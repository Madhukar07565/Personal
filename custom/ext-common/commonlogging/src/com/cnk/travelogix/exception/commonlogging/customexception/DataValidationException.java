...
{
	public static final String ERROR_CODE = "ERROR004";
	 ...
	 * @param message
	 */
	public DataValidationException(final String code, final String message)
	{
		super(code, message);
	}
	 ...
	 * @param message
	 */
	public DataValidationException(final String code, final String handlingCode, final String message)
	{
