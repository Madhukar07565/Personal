 ...
 *
 */
package com.cnk.travelogix.exception.commonlogging.setup;
 ...
 *
 */
@SystemSetup(extension = CommonloggingConstants.EXTENSIONNAME)
public class CommonloggingSystemSetup extends AbstractSystemSetup
{
	...
	protected void importCommonData(final SystemSetupContext context, final String importDirectory)
	{
		...
		importImpexFile(context, importRoot + "/commonlogging.impex", false);
	}
