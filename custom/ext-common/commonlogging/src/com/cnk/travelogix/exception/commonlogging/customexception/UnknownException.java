...
{
	public static final String ERROR_CODE = "ERROR001";
	 ...
	 * @param message
	 */
	public UnknownException(final String code, final String message)
	{
		super(code, message);
	}
	 ...
	 * @param message
	 */
	public UnknownException(final String code, final String handlingCode, final String message)
	{
