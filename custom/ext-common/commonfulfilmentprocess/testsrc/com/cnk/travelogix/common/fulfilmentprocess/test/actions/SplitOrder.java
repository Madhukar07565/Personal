 ...
 *  
 */
package com.cnk.travelogix.common.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(CommonFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(CommonFulfilmentProcessConstants.PARENT_PROCESS);
