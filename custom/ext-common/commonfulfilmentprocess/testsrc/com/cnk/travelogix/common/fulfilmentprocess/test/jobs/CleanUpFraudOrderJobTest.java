 ...
 *  
 */
package com.cnk.travelogix.common.fulfilmentprocess.test.jobs;
...
import com.cnk.travelogix.common.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = CommonFulfilmentProcessConstants.ORDER_PROCESS_NAME;
