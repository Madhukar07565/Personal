 ...
 *
 */
public class MulticityIntlFlightCompanyValueProvider implements CnkFacetValueProvider<FlightResultData>
{
	...
	public Object getFacetValue(final FlightResultData bean, final String propertyName)
	{
		...
		return bean.getListOfFlights().get(0).getAirlineIATA().getAirlineName();
	}
