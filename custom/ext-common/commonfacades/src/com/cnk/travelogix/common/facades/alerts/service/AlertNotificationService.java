 ...
 *
 */
package com.cnk.travelogix.common.facades.alerts.service;
...
/**
 * This class is for invoking Alert & Notification Workflow
 *
 */
public class AlertNotificationService
{
	private static final Logger LOG = Logger.getLogger(AlertNotificationService.class);
			...
			final EmployeeModel employeeModel)
	{
		...
		final WorkflowTemplateModel workflowTemplate = workflowTemplateService.getWorkflowTemplateForCode(Config
				.getParameter("alert.notification.template.code"));
		final WorkflowModel workflow = workflowService.createWorkflow(workflowTemplate, workflowTemplate.getOwner());

		final WorkflowActionModel action = workflow.getActions().stream()
