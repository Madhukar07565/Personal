 ...
 *
 */
public class FlightCnkProductSortHelper implements CnkProductSortHelper<FlightData>
{
	 ...
	 */
	@Override
	public List<FlightData> sortResult(final List<FlightData> result, final CnkFacetValueProvider valueProvider,
