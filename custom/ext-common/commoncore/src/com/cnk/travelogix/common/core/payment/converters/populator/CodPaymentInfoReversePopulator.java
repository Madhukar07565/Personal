...
public class CodPaymentInfoReversePopulator implements Populator<CodPaymentInfoData, CodPaymentInfoModel>
{
	 ...
	 */
	@Override
	public void populate(final CodPaymentInfoData source, final CodPaymentInfoModel target) throws ConversionException
	{
