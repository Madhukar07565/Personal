...
/**
 * Listener for "enable account" functionality event.
 */
public class B2cAccountEnableEventListener extends AbstractAcceleratorSiteEventListener<B2cAccountEnableEvent>
{
	...
	@Override
	protected void onSiteEvent(final B2cAccountEnableEvent event)
	{
		final ForgottenPasswordProcessModel forgottenPasswordProcessModel = (ForgottenPasswordProcessModel) getBusinessProcessService()
				.createProcess("customerEnableEmailProcess-" + event.getCustomer().getUid() + "-" + System.currentTimeMillis(),
						"customerEnableEmailProcess");
	...
	@Override
	protected SiteChannel getSiteChannelForEvent(final B2cAccountEnableEvent event)
	{
