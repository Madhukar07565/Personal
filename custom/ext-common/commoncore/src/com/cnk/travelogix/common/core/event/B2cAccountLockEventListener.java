 ...
 */
public class B2cAccountLockEventListener extends AbstractAcceleratorSiteEventListener<B2cAccountLockEvent>
{
	...
	@Override
	protected void onSiteEvent(final B2cAccountLockEvent registerEvent)
	{
		final StoreFrontCustomerProcessModel storeFrontCustomerProcessModel = (StoreFrontCustomerProcessModel) getBusinessProcessService()
				.createProcess("customerLockEmailProcess-" + registerEvent.getCustomer().getUid() + "-" + System.currentTimeMillis(),
						"customerLockEmailProcess");
	...
	@Override
	protected SiteChannel getSiteChannelForEvent(final B2cAccountLockEvent event)
	{
