 ...
 *  
 */
package com.cnk.travelogix.common.core.hmc;
...
/**
 * Provides necessary meta information about the commoncore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class CommonCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(CommonCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.cnk.travelogix.common.core.hmc.locales";
