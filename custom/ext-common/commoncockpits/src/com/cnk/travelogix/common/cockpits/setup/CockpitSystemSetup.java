 ...
 *  
 */
package com.cnk.travelogix.common.cockpits.setup;
...
import com.cnk.travelogix.common.cockpits.constants.CommonCockpitsConstants;
 ...
 */
@SystemSetup(extension = CommonCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(CommonCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(CommonCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						CommonCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/commoncockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
