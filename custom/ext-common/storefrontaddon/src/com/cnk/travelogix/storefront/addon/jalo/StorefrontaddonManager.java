 ...
 *  
 */
package com.cnk.travelogix.storefront.addon.jalo;
...
import com.cnk.travelogix.storefront.addon.constants.StorefrontaddonConstants;



/**
 * This is the extension manager of the Storefrontaddon extension.
 */
public class StorefrontaddonManager extends GeneratedStorefrontaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(StorefrontaddonManager.class.getName());
	 ...
	 */
	public static StorefrontaddonManager getInstance()
	{
		return (StorefrontaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				StorefrontaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public StorefrontaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of StorefrontaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of StorefrontaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of StorefrontaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
