...
/**
 * This is the extension manager of the Sapintegrations extension.
 */
public class SapintegrationsManager extends GeneratedSapintegrationsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapintegrationsManager.class.getName());
	 ...
	 */
	public static SapintegrationsManager getInstance()
	{
		return (SapintegrationsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapintegrationsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapintegrationsManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapintegrationsManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapintegrationsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapintegrationsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
