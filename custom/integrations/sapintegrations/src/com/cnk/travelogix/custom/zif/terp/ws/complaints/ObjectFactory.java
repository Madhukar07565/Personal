 ...
 * com.cnk.travelogix.custom.zif.terp.ws.complaints package.
 * <p>
...
public class ObjectFactory implements DTOObjectFactory
{
	...
	private final static QName _ZifTerpComplaints_QNAME = new QName("urn:sap-com:document:sap:soap:functions:mc-style",
			"ZifTerpComplaints");
	private final static QName _ZifTerpComplaintsResponse_QNAME = new QName("urn:sap-com:document:sap:soap:functions:mc-style",
			"ZifTerpComplaintsResponse");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package:
	 * com.cnk.travelogix.custom.zif.terp.ws.complaints
	 *
	 */
	...
	@XmlElementDecl(namespace = "urn:sap-com:document:sap:soap:functions:mc-style", name = "ZifTerpComplaints")
	...
	@XmlElementDecl(namespace = "urn:sap-com:document:sap:soap:functions:mc-style", name = "ZifTerpComplaintsResponse")
