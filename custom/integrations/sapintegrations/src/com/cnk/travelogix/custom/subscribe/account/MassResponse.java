...
@XmlType(name = "MassResponse", namespace = "http://schema.ws.highdeal.com/", propOrder = {
    "failures"
})
@XmlSeeAlso({
    PrepaidAccountMaintainMassResponse.class,
    ExternalAccountMaintainMassResponse.class,
    SubscriberAccountMaintainMassResponse.class
})
