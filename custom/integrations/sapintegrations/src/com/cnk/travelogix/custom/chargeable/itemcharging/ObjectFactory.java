...
package com.cnk.travelogix.custom.chargeable.itemcharging;
 ...
 * com.highdeal.ws.charging.schema package.
 * <p>
...
public class ObjectFactory implements DTOObjectFactory
{
	...
	private final static QName _ChargeableItemCheckChargeRequest_QNAME = new QName("http://schema.charging.ws.highdeal.com/",
			"chargeableItemCheckChargeRequest");
	private final static QName _ChargeableItemChargeMassResponse_QNAME = new QName("http://schema.charging.ws.highdeal.com/",
			"chargeableItemChargeMassResponse");
	private final static QName _ChargeableItemChargeRequest_QNAME = new QName("http://schema.charging.ws.highdeal.com/",
			"chargeableItemChargeRequest");
	private final static QName _ChargeableItemChargeBundleRequest_QNAME = new QName("http://schema.charging.ws.highdeal.com/",
			"chargeableItemChargeBundleRequest");
	private final static QName _ChargeableItemChargeBundleResponse_QNAME = new QName("http://schema.charging.ws.highdeal.com/",
			"chargeableItemChargeBundleResponse");
	private final static QName _ChargeableItemChargeResponse_QNAME = new QName("http://schema.charging.ws.highdeal.com/",
			"chargeableItemChargeResponse");
	private final static QName _ChargeableItemCheckChargeResponse_QNAME = new QName("http://schema.charging.ws.highdeal.com/",
			"chargeableItemCheckChargeResponse");
	private final static QName _ChargeableItemChargeMassRequest_QNAME = new QName("http://schema.charging.ws.highdeal.com/",
			"chargeableItemChargeMassRequest");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package:
	 * com.highdeal.ws.charging.schema
	 * 
	 */
	...
	public JAXBElement<ChargeableItemCheckChargeRequest> createChargeableItemCheckChargeRequest(
			final ChargeableItemCheckChargeRequest value)
	{
		return new JAXBElement<ChargeableItemCheckChargeRequest>(_ChargeableItemCheckChargeRequest_QNAME,
				ChargeableItemCheckChargeRequest.class, null, value);
	}
	...
	public JAXBElement<ChargeableItemChargeMassResponse> createChargeableItemChargeMassResponse(
			final ChargeableItemChargeMassResponse value)
	{
		return new JAXBElement<ChargeableItemChargeMassResponse>(_ChargeableItemChargeMassResponse_QNAME,
				ChargeableItemChargeMassResponse.class, null, value);
	}
	...
	public JAXBElement<ChargeableItemChargeRequest> createChargeableItemChargeRequest(final ChargeableItemChargeRequest value)
	{
		return new JAXBElement<ChargeableItemChargeRequest>(_ChargeableItemChargeRequest_QNAME, ChargeableItemChargeRequest.class,
				null, value);
	}
	...
	public JAXBElement<ChargeableItemChargeBundleRequest> createChargeableItemChargeBundleRequest(
			final ChargeableItemChargeBundleRequest value)
	{
		return new JAXBElement<ChargeableItemChargeBundleRequest>(_ChargeableItemChargeBundleRequest_QNAME,
				ChargeableItemChargeBundleRequest.class, null, value);
	}
	...
	public JAXBElement<ChargeableItemChargeBundleResponse> createChargeableItemChargeBundleResponse(
			final ChargeableItemChargeBundleResponse value)
	{
		return new JAXBElement<ChargeableItemChargeBundleResponse>(_ChargeableItemChargeBundleResponse_QNAME,
				ChargeableItemChargeBundleResponse.class, null, value);
	}
	...
	public JAXBElement<ChargeableItemChargeResponse> createChargeableItemChargeResponse(final ChargeableItemChargeResponse value)
	{
		return new JAXBElement<ChargeableItemChargeResponse>(_ChargeableItemChargeResponse_QNAME,
				ChargeableItemChargeResponse.class, null, value);
	}
	...
	public JAXBElement<ChargeableItemCheckChargeResponse> createChargeableItemCheckChargeResponse(
			final ChargeableItemCheckChargeResponse value)
	{
		return new JAXBElement<ChargeableItemCheckChargeResponse>(_ChargeableItemCheckChargeResponse_QNAME,
				ChargeableItemCheckChargeResponse.class, null, value);
	}
	...
	public JAXBElement<ChargeableItemChargeMassRequest> createChargeableItemChargeMassRequest(
			final ChargeableItemChargeMassRequest value)
	{
		return new JAXBElement<ChargeableItemChargeMassRequest>(_ChargeableItemChargeMassRequest_QNAME,
				ChargeableItemChargeMassRequest.class, null, value);
	}
