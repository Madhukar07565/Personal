 ...
 *
 */
public class DefaultSubscriberAccMaintainRequestProcessor
		extends AbstractRequestProcessor<SubscriberAccountMaintainRequest, SubscriberAccountOperationResponse>
		implements SubscriberAccMaintainRequestProcessor
{
	...
	@Override
	protected RequestMessage translateRequest(final SubscriberAccountMaintainRequest request)
	{
		final RequestMessage requestMessage = new RequestMessage<SubscriberAccountMaintainRequest>();
		requestMessage.setRequestObject(getObjectFactory().createSubscriberAccountMaintainRequest(request));
		requestMessage.setServiceInterface(SubscriberAccMaintainRequestProcessor.class);
