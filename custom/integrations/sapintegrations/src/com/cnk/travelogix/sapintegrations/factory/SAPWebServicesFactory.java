 ...
 *
 */
public interface SAPWebServicesFactory
{
	<T extends RequestProcessor> T createSAPWebService(final Class<T> servicesInterface) throws ServiceNotSupportedException;
}
