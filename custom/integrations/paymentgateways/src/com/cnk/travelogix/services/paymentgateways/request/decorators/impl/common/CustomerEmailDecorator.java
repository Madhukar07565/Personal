 ...
 *
 */
public class CustomerEmailDecorator extends PaymentGatewayRequestFormDecorator
{

	/**
	 * @param paymentGatewayProviderRequestForm
	 */
	public CustomerEmailDecorator(final PaymentGatewayRequestForm paymentGatewayProviderRequestForm)
	{
		super(paymentGatewayProviderRequestForm);
		// YTODO Auto-generated constructor stub
	}

	public CustomerEmailDecorator()
	{
		super();
	}
	...
	public FormAttribute processRequestAttibuteValue(final FormAttribute formAttribute, final Map<String, FormAttribute> valueMap)
	{
		...
		if (currCustomerData != null)
		{
			...
			final String customerEmail = StringUtils.isNotBlank(currCustomerData.getDisplayUid())
					? currCustomerData.getDisplayUid().toString() : PaymentGatewayService.PAYMENT_GATEWAY_EMPTY_STRING;

			if (StringUtils.isNotEmpty(customerEmail))
			{
				updateFormAttributeFlags(formAttribute, customerEmail);
			}
