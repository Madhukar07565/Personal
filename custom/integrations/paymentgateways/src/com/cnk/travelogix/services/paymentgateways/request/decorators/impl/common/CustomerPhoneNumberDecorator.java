 ...
 *
 */
public class CustomerPhoneNumberDecorator extends PaymentGatewayRequestFormDecorator
{

	/**
	 * @param paymentGatewayProviderRequestForm
	 */
	public CustomerPhoneNumberDecorator(final PaymentGatewayRequestForm paymentGatewayProviderRequestForm)
	{
		super(paymentGatewayProviderRequestForm);
		// YTODO Auto-generated constructor stub
	}

	public CustomerPhoneNumberDecorator()
	{
		super();
	}
	...
	public FormAttribute processRequestAttibuteValue(final FormAttribute formAttribute, final Map<String, FormAttribute> valueMap)
	{
		...
		if (currCustomerData != null)
		{
			...
			final String customerPhoneNumber = StringUtils.isNotBlank(currCustomerData.getContactNumber())
					? currCustomerData.getContactNumber().toString() : PaymentGatewayService.PAYMENT_GATEWAY_EMPTY_STRING;

			updateFormAttributeFlags(formAttribute, customerPhoneNumber);
