...
import com.cnk.travelogix.constants.GoogleaddonConstants;



/**
 * This is the extension manager of the Googleaddon extension.
 */
public class GoogleaddonManager extends GeneratedGoogleaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(GoogleaddonManager.class.getName());
	 ...
	 */
	public static GoogleaddonManager getInstance()
	{
		return (GoogleaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				GoogleaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public GoogleaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of GoogleaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of GoogleaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of GoogleaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
