...
/**
 * This is the extension manager of the Notifications extension.
 */
public class NotificationsManager extends GeneratedNotificationsManager
{
	...
	{
		return (NotificationsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				NotificationsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public NotificationsManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of NotificationsManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of NotificationsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of NotificationsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
