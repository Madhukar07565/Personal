...
public class AvailabilityAndPriceTest {
	...
	HotelAvailRequestWrapper requestWrapper = new HotelAvailRequestWrapper();
	...
	HotelAvailReadRequest hotelAvailReadRequest = new HotelAvailReadRequest();
	hotelAvailReadRequest.setSequence(1234);
	SupplierID supplierID = new SupplierID();
	supplierID.setValue("ATI");

	hotelAvailReadRequest.setSupplierID(supplierID);
	...
	hotelRef.setHotelCityCode("G1011");
	...
	hotelAvailReadRequest.setHotelAvailRQ(hotelAvailRQ);
	requestWrapper.setRequestHeader(requestHeader);
	requestWrapper.setHotelAvailReadRequest(hotelAvailReadRequest);

	HotelAvailResponseWrapper response = accoService.otaAccoGetAvailabilityAndPrice(requestWrapper);
