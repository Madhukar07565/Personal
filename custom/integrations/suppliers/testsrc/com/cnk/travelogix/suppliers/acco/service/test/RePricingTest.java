...
public class RePricingTest {
	...
	RePricingRequestWrapper requestWrapper = new RePricingRequestWrapper();
	...
	RePricingReadRequest getDetailsReadRequest = new RePricingReadRequest();
	List<RePricingReadRequest> hotelAvailReadRequest = new ArrayList<>();
	...
	requestWrapper.setRePricingReadRequest(hotelAvailReadRequest);

	RePricingResponseWrapper response = accoService.otaAccoRepricing(requestWrapper);
