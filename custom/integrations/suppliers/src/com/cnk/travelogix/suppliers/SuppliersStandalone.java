 ...
 */
package com.cnk.travelogix.suppliers;
 ...
 * <code>
 * java -jar bootstrap/bin/ybootstrap.jar "new com.cnk.travelogix.suppliers.SuppliersStandalone().run();"
 ...
 */
public class SuppliersStandalone {
    /**
     ...
     */
	Logger LOG = Logger.getLogger(SuppliersStandalone.class);
    public static void main(final String[] args) {
	new SuppliersStandalone().run();
    }
