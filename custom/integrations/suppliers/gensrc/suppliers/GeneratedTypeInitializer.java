...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performCreateTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createItemType(
			"CheckFileStatusCronJob",
			"CronJob",
			com.cnk.travelogix.suppliers.jalo.CheckFileStatusCronJob.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			"SendFileStatusProcess",
			"StoreFrontCustomerProcess",
			com.cnk.travelogix.suppliers.jalo.SendFileStatusProcess.class,
			null,
			false,
			null,
			false
	...
	protected final void performModifyTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		// performModifyTypes
				...
				single_createattr_CheckFileStatusCronJob_lastRunTime();
			
				single_createattr_SendFileStatusProcess_email();
			

	}

	
	public void single_createattr_CheckFileStatusCronJob_lastRunTime() throws JaloBusinessException
	{
	...
	public void single_createattr_SendFileStatusProcess_email() throws JaloBusinessException
	{
	...
	protected final void performCreateObjects( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		// performCreateObjects
			...
			single_setAttributeProperties_CheckFileStatusCronJob_lastRunTime();
			...
			single_setAttributeProperties_SendFileStatusProcess_email();
		
	}


		
						public void single_setAttributeProperties_CheckFileStatusCronJob_lastRunTime() throws JaloBusinessException
						{
						...
						public void single_setAttributeProperties_SendFileStatusProcess_email() throws JaloBusinessException
						{
