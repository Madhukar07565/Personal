...
import com.cnk.travelogix.constants.YcommercewebservicesConstants;
import com.cnk.travelogix.formatters.WsDateFormatter;
import com.cnk.travelogix.product.data.ReviewDataList;
import com.cnk.travelogix.product.data.SuggestionDataList;
import com.cnk.travelogix.queues.data.ProductExpressUpdateElementData;
import com.cnk.travelogix.queues.data.ProductExpressUpdateElementDataList;
import com.cnk.travelogix.queues.impl.ProductExpressUpdateQueue;
import com.cnk.travelogix.stock.CommerceStockFacade;
import com.cnk.travelogix.v2.helper.ProductsHelper;
import com.cnk.travelogix.validator.PointOfServiceValidator;
...
public class ProductsController extends BaseController
{
	...
	/**
	 * Returns {@value com.cnk.travelogix.v2.controller.BaseController#HEADER_TOTAL_COUNT} header
			...
			@RequestParam(defaultValue = DEFAULT_FIELD_SET) final String fields)
	{
		...
		final ProductWsDTO dto = getDataMapper().map(product, ProductWsDTO.class, fields);
		return dto;
	}
			...
			throws WebserviceValidationException, StockSystemException
	{
		...
		final StockWsDTO dto = getDataMapper().map(stockData, StockWsDTO.class, fields);
		return dto;
	}
			...
			throws WebserviceValidationException
	{
		...
		final ReviewWsDTO dto = getDataMapper().map(reviewDataRet, ReviewWsDTO.class, fields);
		return dto;
	}
