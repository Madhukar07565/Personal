 ...
 *  
 */
package com.cnk.travelogix.context.impl;
...
import com.cnk.travelogix.context.ContextInformationLoader;
import com.cnk.travelogix.exceptions.InvalidResourceException;
import com.cnk.travelogix.exceptions.RecalculationException;
import com.cnk.travelogix.exceptions.UnsupportedCurrencyException;
import com.cnk.travelogix.exceptions.UnsupportedLanguageException;
...
{
	private final String[] urlSplitters =
	{ "/v1/", "/v2/" };
