...
import com.cnk.travelogix.constants.FacebookaddonConstants;



/**
 * This is the extension manager of the Facebookaddon extension.
 */
public class FacebookaddonManager extends GeneratedFacebookaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(FacebookaddonManager.class.getName());
	 ...
	 */
	public static FacebookaddonManager getInstance()
	{
		return (FacebookaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				FacebookaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public FacebookaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of FacebookaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of FacebookaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of FacebookaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
