 ...
 */
package com.cnk.travelogix.corp.facades.jalo;
...
import com.cnk.travelogix.corp.facades.constants.CorporatefacadesConstants;



/**
 * This is the extension manager of the Corporatefacades extension.
 */
public class CorporatefacadesManager extends GeneratedCorporatefacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CorporatefacadesManager.class.getName());
	 ...
	 */
	public static CorporatefacadesManager getInstance()
	{
		return (CorporatefacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CorporatefacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CorporatefacadesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CorporatefacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CorporatefacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CorporatefacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
