 ...
 */
package com.cnk.travelogix.corp.services.jalo;
...
import com.cnk.travelogix.corp.services.constants.CorporateservicesConstants;



/**
 * This is the extension manager of the Corporateservices extension.
 */
public class CorporateservicesManager extends GeneratedCorporateservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CorporateservicesManager.class.getName());
	 ...
	 */
	public static CorporateservicesManager getInstance()
	{
		return (CorporateservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CorporateservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CorporateservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CorporateservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CorporateservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CorporateservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
