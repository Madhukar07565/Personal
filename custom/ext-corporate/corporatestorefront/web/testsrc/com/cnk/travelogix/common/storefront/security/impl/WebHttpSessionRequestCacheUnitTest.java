...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/corporatestorefront/electronics/en",
						"https://electronics.local:9002/corporatestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/corporatestorefront/electronics/en",
						"https://electronics.local:9002/corporatestorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/corporatestorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/corporatestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/corporatestorefront/electronics/en",
						"https://electronics.local:9002/corporatestorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/corporatestorefront",
						"https://electronics.local:9002/corporatestorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/corporatestorefront",
						"https://electronics.local:9002/corporatestorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/corporatestorefront/electronics/en",
						"https://electronics.local:9002/corporatestorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
