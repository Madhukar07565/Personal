 ...
 */
package com.cnk.travelogix.b2b.services.jalo;
...
import com.cnk.travelogix.b2b.services.constants.B2bservicesConstants;



/**
 * This is the extension manager of the B2bservices extension.
 */
public class B2bservicesManager extends GeneratedB2bservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(B2bservicesManager.class.getName());
	 ...
	 */
	public static B2bservicesManager getInstance()
	{
		return (B2bservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				B2bservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public B2bservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of B2bservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of B2bservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of B2bservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
