 ...
 *
 */
package com.cnk.travelogix.common.storefront.interceptors.beforeview;
...
import com.cnk.travelogix.common.storefront.util.CSRFTokenManager;
import com.cnk.travelogix.common.storefront.web.view.UiExperienceViewResolver;
...
public class UiThemeResourceBeforeViewHandler implements BeforeViewHandler
{
	...
	public void beforeView(final HttpServletRequest request, final HttpServletResponse response, final ModelAndView modelAndView)
	{
		...
		//TODO:switch between desktop and responsive
		//final String cnkcsspath = siteRootUrl + "/" + "cnk";
		modelAndView.addObject("cnkAddonCsspath", contextPath + "/_ui/addons/storefrontaddon/responsive/cnk");
		modelAndView.addObject("cnkcsspath", contextPath + "/_ui/responsive/cnk");
		modelAndView.addObject("cnkJsPath", contextPath + "/_ui/addons/storefrontaddon/responsive/cnk/js");
		modelAndView.addObject("cnkImagesPath", contextPath + "/_ui/responsive/cnk/images/b2b-images");
		modelAndView.addObject("cnkAddonImagesPath", contextPath + "/_ui/addons/storefrontaddon/responsive/cnk/images");

		modelAndView.addObject("ezgCssPath", contextPath + "/_ui/responsive/ezg/css");
		modelAndView.addObject("ezgJsPath", contextPath + "/_ui/responsive/ezg/js");
		modelAndView.addObject("ezgImagesPath", contextPath + "/_ui/responsive/ezg/images");
		modelAndView.addObject("ezgCommonImagesPath", contextPath + "/_ui/responsive/ezg/images/common");
		modelAndView.addObject("ezgAddonImagesPath", contextPath + "/_ui/addons/storefrontaddon/responsive/ezg/images");
		modelAndView.addObject("ezgAddonJsPath", contextPath + "/_ui/addons/storefrontaddon/responsive/ezg/js");
