...
document.body.style.overflow='auto';		
	...
	$('.portViewTab').on('click', function (e) {
		...
		$(this).parent().siblings().find(".portViewTab img").attr("src","images/b2b-images/collapse_blu.png");
...
$(document).ready(function () {
	$('.modSrcBtn').on('click', function (e) {
		...
		$(this).toggleClass("active");
		if ($(this).hasClass('active')) {
			$(this).find('img').attr('src','images/b2b-images/down-arrow-wht.png');		   
		}else{
			$(this).find('img').attr('src','images/b2b-images/right-arrow-wht.png');
		}
	});	
});
...
$(document).ready(function () {
	$('#portmoresrc').on('click', function (e) {
		...
		if ($(this).hasClass('active')) {
			//$(this).find('img').attr('src','images/b2b-images/expand_blu.png');
			$("#portmoresrc").html('<a href="javascript:void(0);"><img src="images/b2b-images/expand_blu.png" alt="Arrow" class="mR5 fL mT5">less</a>')	
				   
		}else{
			//$(this).find('img').attr('src','images/b2b-images/collapse_blu.png');
			$("#portmoresrc").html('<a href="javascript:void(0);"><img src="images/b2b-images/collapse_blu.png" alt="Arrow" class="mR5 fL mT5">more</a>')	
		}
	});	
});
...
function showHide(divID, imgID){
		...
		if( document.getElementById('selectContainer1').style.display == "none")
		{
			...
			document.getElementById('dirImg').src = "images/b2b-images/bin.png";
...
function showHide1(divID, imgID){
		...
		if( document.getElementById('selectContainer2').style.display == "none")
		{
			...
			document.getElementById('dirImg2').src = "images/b2b-images/bin.png";
...
// {
	...
	// {
		...
		// liElem.innerHTML = '<div class="clearfix pL0 searchedResult" id="searchedResult' + compareHotelNo + '"><div class="fL mR10 mT5 mB5"> <img alt="Hotel Thumb" src="images/b2b-images/common/hotel_thumb.png"> </div><div class="fL"><div class="fcWht">' + document.getElementById("hotelName" + compareHotelNo).innerHTML  + '</div><div class="fcWht fS11">Delhi, India</div><div class="fcWht fS11">Standard Double Room with breakfast, 2 nights</div><div class="clearfix"><div class="fS22 fW400 fL fcWht"><span class="rupee">Rs</span>' + document.getElementById("hotelPrice" + compareHotelNo).innerHTML  + '</div></div></div></div>';
...
function showSelectedRooms(selectedRoomValue){
    ...
    if($("#roomShortlist" + selectedRoomValue).val() > 0)
	{
		...
		liElem.innerHTML = '<div class="clearfix fL pL0 searchedResult" id="addedRoom' + selectedRoomValue + '"><div class="fL mR10 mB5"> <img alt="Hotel Thumb" src="images/b2b-images/hotel6_thumb.jpg"> </div><div class="fL"><div class="fcWht fW600 fS11">Radisson Blu Dwarka</div><div class="fcWht fS11">Standard Double<br> Room with breakfast</div><div class="fcWht fS11">2 Rooms</div></div><div class="mT5 dB fR mL10"><img src="images/b2b-images/bin.png" alt="delete" ></div></div>';
...
function selectFlightHotel(){
	...
	document.getElementById("selectedFlightHotel").innerHTML = '<div class="col_3 pL10 pR0 pB10 pT10"><div id="selectedHotelThumb1" class="fL"><img src="images/b2b-images/hotel6_thumb.jpg"></div><div class="fL mL10 hotelDetailContent"><span class="fW600"><a id="selectedHotelName1" href="javascript:void(0)">Radisson Blue Dwarka</a></span><br><span class="rating_star_full_icon"></span><span class="rating_star_full_icon"></span><span class="rating_star_full_icon"></span><span class="rating_star_full_icon"></span><span class="rating_star_no_icon"></span><span class="fS12">4 Star</span><br><span class="fS12" id="selectedHotelLocation1">Airport Zone/ Mahipalpur Road</span><br><span class="fS12" id="selectedHotelRoom1">Superior room</span><br><span><a href="javascript:void(0)">Change hotel</a></span></div></div><div class="col_1 tC pL0 pR0 plus pT30">+</div><div class="col_3 pL0 pR0 pT10 pB10"><div class="mB10 clearfix"><span class="fW600">Departure flight</span><br><span class="fW600" id="selectedDepFlight1">BOM – DEL</span> , <span id="selectedDepFlightDate1">25 Sep 2014</span></div><div class="col_4 pR0 pL0"><div><img src="images/b2b-images/indigo_vsmllogo_sqr.png" alt="IndiGo logo" /></div><div class="fS12"><span id="selectedDepAirline1">IndiGo</span> <br /><span id="selectedDepFlightNo1">G8- 116</span> </div></div><div class="col_8 pR0 pL0 mTN5"><div class="fS12 mB5" id="selectedDepTime1">04:00 – 06:15</div><div class="fS12" id="selectedDepDuration1">02h 15m | Non stop</div></div></div><div class="col_3 pL0 pR0 pT10 pB10"><div class="mB10 clearfix"><span class="fW600">Arrival flight</span><br><span class="fW600" id="selectedArrFlight1">BOM – DEL</span> , <span id="selectedArrFlightDate1">25 Sep 2014</span></div><div class="col_4 pR0 pL0"><div><img src="images/b2b-images/indigo_vsmllogo_sqr.png" alt="IndiGo logo" /></div><div class="fS12"><span id="selectedArrAirline1">IndiGo</span> <br /><span id="selectedArrFlightNo1">G8- 116</span> </div></div><div class="col_8 pR0 pL0 mTN5"><div class="fS12 mB5" id="selectedArrTime1">04:00 – 06:15</div><div class="fS12" id="selectedArrDuration1">02h 15m | Non stop</div></div></div><div class="col_2 pL0 pR0 fR"><div class="bkgGrn pT10 pB10 clearfix"><div class="col_12 pR0 pL10"><div class="fS18"><div class="clearfix mB5"><div class="fL"><a href="javascript:void(0)"><span class="rupee">Rs </span><span class="fW600" id="compPrice">40,780</span></a></div><div class="faq_sml_icon fL mT5 mL5"></div></div></div><div class="fS12 clearfix mB15">for 2 Adults, 1 Child, 3 Nights</div><span >Markup <span id="markup3"><a href="javascript:void(0);"><span class="rupee">Rs </span><span id="markupVal3">1,650</span></a><span class="edit_sml_icon mL5" onClick="showFareEdit(3);"></span></span> </span><br><a href="javascript:void(0)" class="mR20 fL fS12 mT10">Shortlist</a><span class="primaryBtn_sml mR10 fL mT10 mB15"><a href="javascript:void(0);">Book</a></span></div><br class="cB"></div></div>';	
}
