...
//Tabs functionality
   $('.secTab .tabsec a').on('click', function(e)  {
...
$(document).ready(function () {
	$('#portmoresrc3').on('click', function (e) {
		...
		if ($(this).hasClass('active')) {
			//$(this).find('img').attr('src','images/expand_blu.png');
			$("#portmoresrc3").html('<a href="javascript:void(0);"><img src="images/expand_blu.png" alt="Arrow" class="mR5 fL mT5">less</a>')	
				   
		}else{
			//$(this).find('img').attr('src','images/collapse_blu.png');
			$("#portmoresrc3").html('<a href="javascript:void(0);"><img src="images/collapse_blu.png" alt="Arrow" class="mR5 fL mT5">more</a>')	
		}
	});	
});
...
$(document).ready(function () {
	$('#portmoresrc4').on('click', function (e) {
		...
		if ($(this).hasClass('active')) {
			//$(this).find('img').attr('src','images/expand_blu.png');
			$("#portmoresrc4").html('<a href="javascript:void(0);"><img src="images/expand_blu.png" alt="Arrow" class="mR5 fL mT5">less</a>')	
				   
		}else{
			//$(this).find('img').attr('src','images/collapse_blu.png');
			$("#portmoresrc4").html('<a href="javascript:void(0);"><img src="images/collapse_blu.png" alt="Arrow" class="mR5 fL mT5">more</a>')	
		}
	});	
});
...
id1=1+x1;
id2=2+x2;
$(wrapper).append('<ul class="mB10 clearfix"><li class="col_8 pR0 pL0"><label class="mT10">Flight '+id1+':</label><div class="search-bar grey_border fL mR20 w47pcnt"><input type="text" class="sfield w95pcnt" name="searchterm" placeholder="From" id="mwFlight1From" /><input type="image" class="fromDestination" name="search" alt="Search" title="Search" src="images/destination_from.png" /></div><div class="search-bar grey_border fL w47pcnt"><input type="text" class="sfield w95pcnt" name="searchterm" placeholder="To" id="mwFlight1To" /><input type="image" class="toDestination" name="search" alt="Search" title="Search" src="images/destination_to.png" /></li><li class="col_3 mT10"><label>Departure</label><input id="datepicker'+id2+'" class="w70pcnt dateField" type="text" placeholder="DD/MM/YYYY" readonly /></li><li class="col_1 mT30 pR0 remove_field" style="position:absolute;"><span class="popup_close_icon"></span></li></ul>'); //add input box
...
$(wrapper).append('<div class=" clearfix" id="card_'+x1+'"> <table  class="dataTablebtm col_12 mT20imp "> <tr> <th class="w215">'+$('#CardHolderName').val()+'</th> <th ><span class="mR10">Transaction limit </span>Rs. <input type="text" class="w50pcnt mL5" name="limit" value="10,00,000" /></th> <th><span class="mR10">Master service fee</span> Rs. <input type="text" class="w50pcnt mL5" name="fee" value="100" /></th> </tr> </table>  <table  class=" dataTable  col_12"> <tr> <td>Card holder name</td> <td>Card number</td> <td>Expiry date</td> <td>Card type</td> </tr> <tr> <td>Mr Amal Mehta</td> <td>XXXX XXXX XXXX 6790</td> <td>09 / 20</td> <td><img src="images/visa.png" alt="card"/></td> </tr> </table> <a href="javascript:void(0);" onclick="popupwin(\'deactivate\',\'deactivateinner\',\'fade\'),remove_card('+x1+')">Remove Card</a> </div>'); //add input box
...
if ($(this).hasClass('active')) {
//$(this).find('img').attr('src','images/expand_blu.png');
$("#portmoresrc1").html('<a href="javascript:void(0);"><img src="images/expand_blu.png" alt="Arrow" class="mR5 fL mT5">less</a>');

}else{
//$(this).find('img').attr('src','images/collapse_blu.png');
$("#portmoresrc1").html('<a href="javascript:void(0);"><img src="images/collapse_blu.png" alt="Arrow" class="mR5 fL mT5">more</a>')	;
}
});
});
...
if ($(this).hasClass('active')) {
//$(this).find('img').attr('src','images/expand_blu.png');
$("#portmoresrc2").html('<a href="javascript:void(0);"><img src="images/expand_blu.png" alt="Arrow" class="mR5 fL mT5">less</a>')	;

}else{
//$(this).find('img').attr('src','images/collapse_blu.png');
$("#portmoresrc2").html('<a href="javascript:void(0);"><img src="images/collapse_blu.png" alt="Arrow" class="mR5 fL mT5">more</a>')	;
}
});
});
...
$('.payhotels').find('img').attr('src','images/collapse_blu.png');
$('.payCars').removeClass('active');
$('.payCars').find('img').attr('src','images/collapse_blu.png');
$('.payBus').removeClass('active');
$('.payBus').find('img').attr('src','images/collapse_blu.png');
$('.payEurailPass').removeClass('active');
$('.payEurailPass').find('img').attr('src','images/collapse_blu.png');
$('.payEurailTicket').removeClass('active');
$('.payEurailTicket').find('img').attr('src','images/collapse_blu.png');
$('.payActivity').removeClass('active');
$('.payActivity').find('img').attr('src','images/collapse_blu.png');
$('.payCruise').removeClass('active');
$('.payCruise').find('img').attr('src','images/collapse_blu.png');
$('.payVisa').removeClass('active');
$('.payVisa').find('img').attr('src','images/collapse_blu.png');
$('.payInsurance').removeClass('active');
$('.payInsurance').find('img').attr('src','images/collapse_blu.png');
$('.payFlightHotel').removeClass('active');
$('.payFlightHotel').find('img').attr('src','images/collapse_blu.png');
$('.payFlightHotelCar').removeClass('active');
$('.payFlightHotelCar').find('img').attr('src','images/collapse_blu.png');
$('.payHoliday').removeClass('active');
$('.payHoliday').find('img').attr('src','images/collapse_blu.png');
$('.payForex').removeClass('active');
$('.payForex').find('img').attr('src','images/collapse_blu.png');
$(this).toggleClass("active");
if ($(this).hasClass('active')) {
$(this).find('img').attr('src','images/expand_blu.png');
}else{
...
$('.payFlights').find('img').attr('src','images/collapse_blu.png');
$('.payCars').removeClass('active');
$('.payCars').find('img').attr('src','images/collapse_blu.png');
$('.payBus').removeClass('active');
$('.payBus').find('img').attr('src','images/collapse_blu.png');
$('.payEurail').removeClass('active');
$('.payEurail').find('img').attr('src','images/collapse_blu.png');
$('.payActivity').removeClass('active');
$('.payActivity').find('img').attr('src','images/collapse_blu.png');
$('.payCruise').removeClass('active');
$('.payCruise').find('img').attr('src','images/collapse_blu.png');
...
$('.sumHotels').find('img').attr('src','images/collapse_blu.png');
$('.sumCars').removeClass('active');
$('.sumCars').find('img').attr('src','images/collapse_blu.png');
$('.sumBus').removeClass('active');
$('.sumBus').find('img').attr('src','images/collapse_blu.png');
$('.sumEurailPass').removeClass('active');
$('.sumEurailPass').find('img').attr('src','images/collapse_blu.png');
$('.sumEurailTckt').removeClass('active');
$('.sumEurailTckt').find('img').attr('src','images/collapse_blu.png');
$('.sumActivity').removeClass('active');
$('.sumActivity').find('img').attr('src','images/collapse_blu.png');
$('.sumCruise').removeClass('active');
$('.sumCruise').find('img').attr('src','images/collapse_blu.png');
$('.sumVisa').removeClass('active');
$('.sumVisa').find('img').attr('src','images/collapse_blu.png');
$('.sumInsurance').removeClass('active');
$('.sumInsurance').find('img').attr('src','images/collapse_blu.png');
$('.sumFlightHotel').removeClass('active');
$('.sumFlightHotel').find('img').attr('src','images/collapse_blu.png');
$('.sumFlightHotelCar').removeClass('active');
$('.sumFlightHotelCar').find('img').attr('src','images/collapse_blu.png');
$('.sumHoliday').removeClass('active');
$('.sumHoliday').find('img').attr('src','images/collapse_blu.png');
$('.sumForex').removeClass('active');
$('.sumForex').find('img').attr('src','images/collapse_blu.png');
$(this).toggleClass("active");
if ($(this).hasClass('active')) {
$(this).find('img').attr('src','images/expand_blu.png');
}else{
...
$('.sumFlights').find('img').attr('src','images/collapse_blu.png');
$('.sumCars').removeClass('active');
$('.sumCars').find('img').attr('src','images/collapse_blu.png');
$('.sumBus').removeClass('active');
$('.sumBus').find('img').attr('src','images/collapse_blu.png');
...
$('.PayInfo').find('img').attr('src','images/collapse_blu.png');
$('.AgntInfo').removeClass('active');
$('.AgntInfo').find('img').attr('src','images/collapse_blu.png');
$('.KycInfo').removeClass('active');
$('.KycInfo').find('img').attr('src','images/collapse_blu.png');
$(this).toggleClass("active");
if ($(this).hasClass('active')) {
$(this).find('img').attr('src','images/expand_blu.png');
}else{
...
document.getElementById('btmTop').style.display = 'block';
if(flightLeg == 1){
document.getElementById("selectFlightLeg1").innerHTML = '<span class="wayNum sel mR10" id="multiWayTop1">1</span>BOM - DEL, 25 Sep‘14 <br/><samp class="go_AI mT15"><span>&nbsp;</span></samp><dfn>05.30 – 06.35 <br/>non stop<br/>Indigo 6E 198<br/><a href="javascript:void(0);"  class="fL fW600">Change Flight</a><span class="fR mR40 plus">+</span></dfn><br class="cB"><img src="images/hotel3_thumb.png" alt="" class="fL mT10"/><dfn class="mL15"><a href="javascript:void(0);" class="fW600">Adarsh Hamilton</a><br/>Deluxe  room<br/><span class="rating_star_full_icon"></span><span class="rating_star_full_icon"></span><span class="rating_star_full_icon"></span><span class="rating_star_full_icon"></span><span class="rating_star_full_icon"></span><br/><div class="mR30 mT5"> <span class="mR5"><img alt="Trip Advisor" src="images/ta_logo.jpg"></span> <span class="rating_ct_full_icon"></span> <span class="rating_ct_full_icon"></span> <span class="rating_ct_full_icon"></span> <span class="rating_ct_full_icon"></span> <span class="rating_ct_no_icon"></span> </div><a href="javascript:void(0);" class="fW600">Change Hotel</a></dfn>';
leg1Added = 1;
}
if(flightLeg == 2){
...
function show_SelectedRooms(selectedRoomValue){
    ...
    if($("#room_Shortlist" + selectedRoomValue).val() > 0)
	{
		...
		liElem.innerHTML = '<div class="clearfix pL0 searchedResult" id="addedRoom' + selectedRoomValue + '"><div class="fL mR10 mB5"> <img alt="Hotel Thumb" src="images/hotel6_thumb.jpg"> </div><div class="fL"><div class="fcWht">' + document.getElementById("roomType" + selectedRoomValue).innerHTML  + '</div><div class="fcWht fS11">Radisson Blu Dwarka</div><div class="fcWht fS11">Standard Double<br> Room with breakfast</div></div></div>';
			...
			$(this).text(' + View Details');
              ...
              $(document).ready(function() {
				   ...
				   $('#next').click(function(){
					 $('#myTable_next').trigger('click');
					  $('#myTable .closeCtr').remove();
					   $('.expandCtr a').html('<img src="images/collapse_blu.png" alt="Arrow" class="mR5 fL mT5">');
				});
                ...
                $('#bookingtestBtn').click(function(){
					   ...
					   {
					    $('#bookingtestBtn a').html('<img src="images/expand_blu.png" alt="Arrow" class="mR5 fL mT5">');
					 ...
					 else
					 {
					  $('#myTable #adddetaillist').remove();
					   $('#bookingtestBtn a').html('<img src="images/collapse_blu.png" alt="Arrow" class="mR5 fL mT5">');
                ...
                $('#bookingtestBtn1').click(function(){
					   ...
					   {
					    $('#bookingtestBtn1 a').html('<img src="images/expand_blu.png" alt="Arrow" class="mR5 fL mT5">');
					 ...
					 else
					 {
					  $('#myTable #adddetaillist1').remove();
					   $('#bookingtestBtn1 a').html('<img src="images/collapse_blu.png" alt="Arrow" class="mR5 fL mT5">');
...
$('.laspezia').find('img').attr('src','images/collapse_blu.png');
$('.cannes').removeClass('active');
$('.cannes').find('img').attr('src','images/collapse_blu.png');
$('.palma').removeClass('active');
$('.palma').find('img').attr('src','images/collapse_blu.png');
$('.barcelona').removeClass('active');
$('.barcelona').find('img').attr('src','images/collapse_blu.png');
...
$('.Civitavecchia').find('img').attr('src','images/collapse_blu.png');
$('.cannes').removeClass('active');
$('.cannes').find('img').attr('src','images/collapse_blu.png');
$('.palma').removeClass('active');
$('.palma').find('img').attr('src','images/collapse_blu.png');
...
$('.absolute').find('img').attr('src','images/collapse_blu.png');
$('.angelsDemons').removeClass('active');
$('.angelsDemons').find('img').attr('src','images/collapse_blu.png');
$('.walkingTour').removeClass('active');
$('.walkingTour').find('img').attr('src','images/collapse_blu.png');
$('.granTour').removeClass('active');
$('.granTour').find('img').attr('src','images/collapse_blu.png');
$('.vatican').removeClass('active');
$('.vatican').find('img').attr('src','images/collapse_blu.png');
$('.baroque').removeClass('active');
$('.baroque').find('img').attr('src','images/collapse_blu.png');
$('.yourOwn').removeClass('active');
$('.yourOwn').find('img').attr('src','images/collapse_blu.png');
...
$('.bikeTour').find('img').attr('src','images/collapse_blu.png');
$('.angelsDemons').removeClass('active');
$('.angelsDemons').find('img').attr('src','images/collapse_blu.png');
$('.walkingTour').removeClass('active');
$('.walkingTour').find('img').attr('src','images/collapse_blu.png');
