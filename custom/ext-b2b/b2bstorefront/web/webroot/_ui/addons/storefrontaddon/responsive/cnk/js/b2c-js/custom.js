...
$(document).ready(function () {
	...
	$("#callview").click(function()
	{
		...
		$("#chatviewpanel").removeClass("active");	
		$("#chatviewpanel").hide();	
		$("#emailviewpanel").removeClass("active");
		$("#emailviewpanel").hide();
		if ($(this).hasClass('active')) 
		{
			$("#callviewpanel").hide("slow");		   
		}
		else
		{
			$("#callviewpanel").show("slow");		
		}
	});
//chat view function
	...
	{
		$(this).toggleClass("active");
			$("#callviewpanel").removeClass("active");
			$("#callviewpanel").hide();	
			$("#emailviewpanel").removeClass("active");
			$("#emailviewpanel").hide();
		if ($(this).hasClass('active'))
		{
			$("#chatviewpanel").hide("slow");		   
		}
		else
		{
			$("#chatviewpanel").show("slow");		
		}
	});
...
//email view function
	$("#emailview").click(function()
	{
		...
		if ($(this).hasClass('active')) 
		{
			$("#emailviewpanel").hide("slow");		   
		}
		else
		{
			$("#emailviewpanel").show("slow");		
		}
	});
...
function showRoomsNew(){
	...
	if(roomsNew < roomsAddedNew){
		...
		{
			document.getElementById("roomNew" + (roomsAddedNew+1)).innerHTML = '<ul class="row mB10 mT15 clearfix"><li class="col_2">&nbsp;</li><li class="col_2 pR0"> <span class="mT30 fL">Room ' + (roomsAddedNew+1) + ':</span></li><li class="col_2 pL0"><label>Adult</label><div class="passengerNum4 fL"><span onclick="adultCountDec1(\'hAdult5_' + (roomsAddedNew+1) + '\')" class="control addMinControl minusControl">-</span><span class="control innerTxtControl" id="hAdult5_' + (roomsAddedNew+1) + '">1</span><span onclick="adultCountInc1(\'hAdult5_' + (roomsAddedNew+1) + '\')" class="control addMinControl plusControl">+</span></div><input type="text" class="w100pcnt dN" maxlength="3" value="1"><span class="fS11 fL w100pcnt">12+ yrs</span></li><li class="col_2 pL0"><label>Children</label><div class="passengerNum5 fL"> <span onclick="childCountDec1(\'hChild5_' + (roomsAddedNew+1) + '\'),remChild5(' + (roomsAddedNew+1) + '), showToggler();" class="control addMinControl minusControl">-</span> <span class="control innerTxtControl" id="hChild_' + (roomsAddedNew+1) + '">0</span> <span onclick="childCountInc1(\'hChild5_' + (roomsAddedNew+1) + '\'),addChild5(' + (roomsAddedNew+1) + '), showToggler();" class="control addMinControl plusControl">+</span> </div><input type="text" class="w100pcnt dN" maxlength="3" value="0"><span class="fS11 fL w100pcnt">2 - 12 yrs</span> </li><li class="number"><label>Infant</label><div class="adderOuter"><span class="control addMinControl minusControl cursor fW600" onClick="infantCountDec(\'hInfant_1'+(roomsAddedNew+1) + '\'),remInfant(1), showToggler();">-</span> <span class="control innerTxtControl" id="hInfant5_' + (roomsAddedNew+1) + '">0</span> <span class="control addMinControl plusControl cursor fW600" onClick="infantCountInc(\'hInfant_1'+(roomsAddedNew+1) + '\'),addInfant(1), showToggler()">+</span></div><span class="fS11 fL">0-2 yrs</span></li><li class="col_4 mB10"><ul><li class="col_6 pR0" id="child' + (roomsAddedNew+1) + '_21"></li><li class="col_6 pR0" id="child' + (roomsAddedNew+1) + '_22"></li><li class="col_6 pR0" id="child' + (roomsAddedNew+1) + '_23"></li><li class="col_6 pR0" id="child' + (roomsAddedNew+1) + '_24"></li><li class="col_6 pR0" id="child' + (roomsAddedNew+1) + '_25"></li><li class="col_6 pR0" id="child' + r + '_26"></li><li class="col_6 pR0" id="child' + (roomsAddedNew+1) + '_27"></li><li class="col_6 pR0" id="child' + (roomsAddedNew+1) + '_28"></li><li class="col_6 pR0" id="child' + (roomsAddedNew+1) + '_29"></li></ul></li>';
			roomsAddedNew++;
		}
	}
...
function searchFlight10(obj){
	...
	switch(obj)
	{
		case "oneway10":
			...
			document.getElementById('flightSearchPanel20').style.display = 'none';			
			...
			$("#multiwaySearchParameters20, #multiwaySearchParameters21, #multiwaySearchParameters22, #multiwaySearchParameters23").hide();
		...
		case "ticket_port":
			...
			document.getElementById("multiwaySearchDefault10").style.display = "block";		
			document.getElementById("flightSearchPanel20").style.display = "none";		
			document.getElementById("comboOfferTriggers10").style.display = "none";
   			document.getElementById("addCar20").checked = false;
			document.getElementById("addFlight20").checked = false;	
		default :	
...
//Datepicker trigger function
    if($().datepicker){
     // For Dual Calendar
	  $("#departureDate, #departureDate11, #edepartureDate11, #departureDate12, #departureDate13, #edepartureDate13, #edepartureDate14, #departureDate14, #departureDate15, #departureDate16, #departureDate17, #departureDate18, #returnDate10,#returnDate11, #returnDate12, #checkinDate10, #echeckinDate10, #checkoutDate10, #checkoutDate11, #checkinDate12, #checkoutDate12, #checkinDate13, #checkoutDate13, #checkinDate14, #checkoutDate14, #checkinDate15, #checkoutDate15, #pickUpDate10, #epickUpDate10, #dropOffDate10,#pickUpDate11, #dropOffDate11, #twDepartureDate10, #twReturnDate10, #startDate10, #endDate10, #departureDate_eurail11, #departureDate_eurail12, #departureDate_eurail13, #edepartureDate_eurail13, #departureDate_eurail14, #departureDate_eurail15, #departureDate_eurail16, #departureDate_eurail17, #departureDate_eurail18, datepicker14, datepicker15, datepicker16, datepicker17, datepicker18, datepicker19, datepicker20" ).datepicker({
		numberOfMonths:2,
		 minDate: 0,
		dateFormat: "d M, y",
		onSelect: function(dateText){
...
$(document).ready(function () {
	$('.edit_preferences').on('click', function (e) {
		$(".edit_preferencesContr").slideToggle("slow");
		$('.add_Phone_icon').toggleClass("active");
	});	
});
$(document).ready(function () {
	$('.add_card').on('click', function (e) {
		$(".add_cardContr").slideToggle("slow");
		$('.add_Phone_icon').toggleClass("active");
	});	
});
$(document).ready(function () {
	$('.edit_card').on('click', function (e) {
		$(".edit_cardContr").slideToggle("slow");
		$('.add_Phone_icon').toggleClass("active");
	});	
});
$(document).ready(function () {
	$('.add_voucher').on('click', function (e) {
		$(".add_voucherContr").slideToggle("slow");
		$('.add_Phone_icon').toggleClass("active");
	});	
});
...
$(".dropdown1 dt a").on('click', function () {
      ...
      $('.mutliSelect1 input[type="checkbox"]').on('click', function () {
		  ...
		  {
			 $('.multiSel').html('');
			 var html = '<span class="grey_bg fL mR10 w100pcnt fS14" >5+ Accomodation type Selected</span>';
		  ...
		  $('.multiSel').html('');
			...
			property.push($(this).val());
			 if ($(this).is(':checked')) {
              ...
              var html = '<span class="bkgWht pD5 fL mT5 mB5 mR10 posR fS14" title="' + $(this).val() + '" onclick="deselectdropdown(\'' + $(this).val() + '\')"><button class="remove_searched_parameter mR5" title="Remove">×</button><span >' + $(this).val() + '</span></span>';
              $('.multiSel').append(html);
             // $(".hida").hide();
          } 
          else {
...
if($().datepicker){
     // For Dual Calendar
	  $("#effectivefrom,#effectivefrom1,#effectivefrom2,#effectivefrom3,#effectivefrom4,#effectivefrom5,#effectivefrom6,#effectivefrom7,#dob,#dob1,#effectivefrom8,#effectivefrom9,#effectivefrom10,#effectivefrom11,#effectivefrom12,#effectivefrom13,#effectivefrom14" ).datepicker({
		numberOfMonths:2,
		 minDate: 0,
		dateFormat: "d M, y",
		onSelect: function(dateText){
...
$( "#datepicker13, #datepicker14, #datepicker15, #datepicker16, #datepicker17, #datepicker18, #datepicker19, #datepicker20, #datepicker21, #datepicker22, #datepicker23, #datepicker24, #datepicker25, #datepicker26" ).datepicker({
    ...
    $(wrapper).on("click",".close_multicity_panel", function(e){ //user click on remove text
		...
		if($().datepicker){
$( "#datepicker1, #datepicker4, #datepicker5, #datepicker6, #datepicker7, #datepicker8, #datepicker9, #datepicker2, #datepicker10, #datepicker12, #datepicker3, #datepicker11, #datepicker13, #datepicker14, #datepicker15, #datepicker16, #datepicker17, #datepicker18, #datepicker19, #datepicker20 #datepicker21, #datepicker22, #datepicker23, #datepicker24, #datepicker25, #datepicker26, #datepicker27, #datepicker28, #datepicker29, #datepicker30, #datepicker31, #datepicker32, #datepicker33, #datepicker34, #datepicker35, #datepicker36, #datepicker37, #datepicker38" ).datepicker({
		numberOfMonths:2,
		 minDate: 0,
		dateFormat: "dd/mm/yy",
		onSelect: function(dateText){
...
$(function() {
            $( "#datepicker-6" ).datepicker({
               showOn:"button",
               buttonImage: "images/common/calendar_icon.png",
...
function selectMultiFlightact(flightLeg,row){
	...
	$("#shoppingCartTab").addClass('sel');
	if(flightLeg == 1){
		document.getElementById("selectFlightLeg1").innerHTML = '<span class="wayNum mR10 fL" id="multiWayBtm1">1</span><div class=" w5pcnt_imp  fR  ">	<br/><span class="fW600 fS30 mT20">+</span>  </div><div class="fL fS12 w75pcnt"><span class="fL mR10"><img src="images/b2c-images/srp_flight/indigo_sml_logo.jpg" class="mB5" alt="Air India Logo"><span class="fS12 fcWht dB">Air India AI 349</span></span><span class="clearfix fL mTN5 dB"><span class="clearfix dB"><span class="fcWht fL ">Mumbai<br> 11.30</span><span class="flight_icon_sml fL mTB2LR10"></span><span class="fcWht fL ">Delhi<br> 4.35</span></span><span class="fS11 fcWht dB">3h 5m  </span><span class="fS11 fcWht dB">non stop</span></span><span class="mT5 fR cB"><img src="Images/b2c-images/bin.png" alt="delete" onclick="deleteSelect1(1)" /></span> </div>';
		leg1Added = 1;
			$("#multiWayBtm2,#multiWayBtm3,#multiWayBtm4").removeClass("sel");
		$("#multiWayBtm1").addClass("sel");
    ...
    if(flightLeg == 2){
		document.getElementById("selectFlightLeg2").innerHTML = '<span class="wayNum mR10 fL" id="multiWayBtm2">2</span><div class=" w5pcnt_imp  fR  ">	<br/><span class="fW600 fS30 mT20">+</span>  </div><div class="fL w72pcnt"> <span class="fL mR10"><img src="images/b2c-images/srp_flight/indigo_sml_logo.jpg" class="mB5" alt="Air India Logo"><span class="fS12 fcWht dB">Air India AI 349</span></span><span class="clearfix fL mTN5 dB"><span class="clearfix dB"><span class="fcWht fL ">Mumbai<br> 11.30</span><span class="flight_icon_sml fL mTB2LR10"></span><span class="fcWht fL ">Delhi<br> 4.35</span></span><span class="fS11 fcWht dB">3h 5m  </span><span class="fS11 fcWht dB">non stop</span></span><span class="mT5 fR"><img src="Images/b2c-images/bin.png" alt="delete" onclick="deleteSelect1(2)" /></span></div>';
		leg2Added = 1;
			$("#multiWayBtm1,#multiWayBtm3,#multiWayBtm4").removeClass("sel");
		$("#multiWayBtm2").addClass("sel");
	...
	if(flightLeg == 3){
        document.getElementById("selectFlightLeg3").innerHTML = '<span class="wayNum mR10 fL" id="multiWayBtm3">3</span><div class=" w5pcnt_imp  fR  ">	<br/><span class="fW600 fS30 mT20">+</span>  </div><div class="fL w72pcnt"> <span class="fL mR10"><img src="images/b2c-images/srp_flight/indigo_sml_logo.jpg" class="mB5" alt="Air India Logo"><span class="fS12 fcWht dB">Air India AI 349</span></span><span class="clearfix fL mTN5 dB"><span class="clearfix dB"><span class="fcWht fL ">Mumbai<br> 11.30</span><span class="flight_icon_sml fL mTB2LR10"></span><span class="fcWht fL ">Delhi<br> 4.35</span></span><span class="fS11 fcWht dB">3h 5m  </span><span class="fS11 fcWht dB">non stop</span></span><span class="mT5 fR"><img src="Images/b2c-images/bin.png" alt="delete" onclick="deleteSelect1(3)" /></span></div>';
		leg3Added = 1;
	...
	if(flightLeg == 4){
        document.getElementById("selectFlightLeg4").innerHTML = '<span class="wayNum mR10 fL" id="multiWayBtm4">4</span><div class="fL w72pcnt"> <span class="fL mR10"><img src="images/b2c-images/srp_flight/indigo_sml_logo.jpg" class="mB5" alt="Air India Logo"><span class="fS12 fcWht dB">Air India AI 349</span></span><span class="clearfix fL mTN5 dB"><span class="clearfix dB"><span class="fcWht fL ">Mumbai<br> 11.30</span><span class="flight_icon_sml fL mTB2LR10"></span><span class="fcWht fL ">Delhi<br> 4.35</span></span><span class="fS11 fcWht dB">3h 5m  </span><span class="fS11 fcWht dB">non stop</span></span><span class="mT5 fR"><img src="Images/b2c-images/bin.png" alt="delete" onclick="deleteSelect1(4)" /></span></div>';
		leg4Added = 1;
			document.getElementById("selectBooking").style.display = "block";
...
$("#mydates").click(function () {
        if (!$(this).is(':checked')) {
            $('#echeckinDate').datepicker(this.checked ? "disable" : "enable");
            $('#endDate').datepicker(this.checked ? "disable" : "enable");
        }
        else {
            $('#echeckinDate').datepicker(this.checked ? "disable" : "disable");
            $('#endDate').datepicker(this.checked ? "disable" : "disable");
        }
    });
	
$("#mydates1").click(function () {
        if (!$(this).is(':checked')) {
...
function addnewtab(a,e)
{
	$('#priNav5').html('<a href="javascript:void(0);"><span class="morePnl'+a+' fL" style="top:16px"></span>'+e+'</a>');
	$("#mainNav li").parent().find('li').removeClass("sel");
	$("#priNav5").addClass("sel");
	$("#primary_navigation_containerpriNav5").addClass("dN");
	$("#primary_navigation_containerpriNav5").removeAttr( "id" );
	$(".NavNewTab"+a).attr('id', 'primary_navigation_containerpriNav5');
	$(".tabContent").each(function(){
        $(this).hide();
        });
...
function addnewtab1(a,e)
{
	$('#priNav5').html('<a href="javascript:void(0);"><span class="fL" style="top:16px"></span>'+e+'</a>');
	$("#mainNav li").parent().find('li').removeClass("sel");
	$("#priNav5").addClass("sel");
	$("#primary_navigation_containerpriNav5").addClass("dN");
	$("#primary_navigation_containerpriNav5").removeAttr( "id" );
...
function searchFlightNew(obj){
	...
	switch(obj)
	{
		case "oneway5":
			...
			//document.getElementById("pickUpDateHolder").style.display = "none";
			//document.getElementById("dropOffDateHolder").style.display = "none";
			$("#multiwaySearchParameters1, #multiwaySearchParameters2, #multiwaySearchParameters3, #hotelStayPanel").hide();
		...
		case "multicity5":
			...
			document.getElementById("carSearchPanel").style.display = "none";
			document.getElementById("addFlight1").checked = false;	
			$("#flightOptionsSearchPanel, #hotelStayPanel").hide();
			$("#moreFlightOpton1").removeClass("active");
			$("#plusMinus1").text("+")
			showHidePanel = 0;
...
function hideMultiwayOptions10(i){
	...
	if( $("#multiwaySearchParameters20").is(":hidden") &&  $("#multiwaySearchParameters21").is(":hidden") &&  $("#multiwaySearchParameters22").is(":hidden") &&  $("#multiwaySearchParameters23").is(":hidden")  ){
		showHidePanel = 0;
		}
	if(i != 5)
		mcv = i++;
...
//hide show toggle	 
	$(".globalSrcExpContr10").click( function(){
		$("#globalSrcToggle10").slideToggle();
		$(".globalSrcShow10").toggleClass("sel");
		
		if($(".globalSrcShow10").hasClass("sel") ){
			$(".globalSrcShow10").text("Hide");
			}
		else{
			$(".globalSrcShow10").text("Show");
			}	
		}); 
...
function hideShowAcc1(id1, id2)
{
	$("#" + id2).slideToggle("slow");
	$('#'+ id2).toggleClass("active");
		if ($('#'+ id2).hasClass('active')) {
			$('#'+ id1).find('img').attr('src','images/b2c-images/common/expand_blu.png');		   
		}else{
			$('#'+ id1).find('img').attr('src','images/b2c-images/common/collapse_blu.png');
		}
			  
}
var roomsAdded = 1;
function showRooms_new(){
	...
	if(rooms < roomsAdded){
		...
		for(r=1;r<=rAdd;r++)
		{
			document.getElementById("room" + (roomsAdded+1)).innerHTML = '<ul class="row mB10 mT15 clearfix"><li class="col_2">&nbsp;</li><li class="col_2 pR0"> <span class="mT30 fL">Room ' + (roomsAdded+1) + ':</span></li><li class="col_2 pL0"><label>Adult</label><div class="adderOuter"> <span  onclick="adultCountDec(\'hAdult_' + (roomsAdded+1) + '\')" class="control addMinControl minusControl cursor fW600">-</span> <span id="hAdult_' + (roomsAdded+1) + '" class="control innerTxtControl">1</span> <span onclick="adultCountInc(\'hAdult_' + (roomsAdded+1) + '\')" class="control addMinControl plusControl cursor fW600">+</span> </div><input type="text" class="w100pcnt dN" maxlength="3" value="1"><span class="fS11 fL w100pcnt">12+ yrs</span></li><li class="col_2 pL0"><label>Children</label><div class="adderOuter"> <span class="control addMinControl minusControl cursor fW600"  onclick="childCountDec(\'hChild_' + (roomsAdded+1) + '\')">-</span> <span class="control innerTxtControl" id="hChild_' + (roomsAdded+1) + '">0</span> <span class="control addMinControl plusControl cursor fW600" onclick="childCountInc(\'hChild_' + (roomsAdded+1) + '\')">+</span> </div><input type="text" class="w100pcnt dN" maxlength="3" value="0"><span class="fS11 fL w100pcnt">2 - 12 yrs</span> </li> </ul>';
			roomsAdded++;
		}
	}
}
