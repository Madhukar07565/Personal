	...
	<div class="white_content_inner w80pcnt w95pcnt_sm" id="addcustdetailinner">
		...
		<div class="clearfix">
			<div class="fL" style="width:179px">
				<div class="mT30 tC">
					<img src="${ezgImagesPath}/profile-img.jpg" alt="agent image" /><br/>
					<span class="">
		...
		<div class="col_9 col_12_sm pL0 pR0">
			...
			<ul class=" mB10 clearfix ">
				<li class="col_4  pR0">
					...
					<input type="text" class="w100pcnt emailField" placeholder="rahul.sodi@gmail.com"/>
				</li>
				<li class="col_5 pR0 pL5">
					<label class="mB10">&nbsp;</label>
					<a href="javascript:void(0);" class="mT5"><span class="add_details_icon mR5 fL" ></span><span class="posR fL addAnotherFieldButton" id="emailField">Add another</span></a>
				</li>
			</ul>
			<ul class=" mB10 clearfix ">
				<li class="col_4  pR0">
					<label>Contact Number (Home)</label>
					<input type="text" class="w100pcnt contactNumberHomeField" placeholder="0120-26563595"/>
				</li>
				<li class=" col_2 pR0 pL5">
					<label class="mB10">&nbsp;</label>
					<a href="javascript:void(0);" class="mT5"><span class="add_details_icon mR5 fL" ></span><span class="posR fL addAnotherFieldButton" id="contactNumberHomeField">Add another</span></a>
				</li>
				<li class="col_4 pR0">
					<label>Contact Number (Office)</label>
					<input type="text" class="w100pcnt contactNumberOfficeField" placeholder="0120-26563595"/>
				</li>
				<li class=" col_2 pR0 pL5">
					<label class="mB10">&nbsp;</label>
					<a href="javascript:void(0);" class="mT5"><span class="add_details_icon mR5 fL" ></span><span class="posR fL addAnotherFieldButton" id="contactNumberOfficeField" >Add another</span></a>
				</li>
			</ul>
			<label class="pL20">Mobile Number</label>
				<ul class=" mB10 clearfix">
					...
					<li class="col_5 pR0 pL5 clearfix pT5">
						<a href="javascript:void(0);" class="mT10"><span class="add_details_icon mR5 fL" ></span><span class="posR fL addAnotherFieldButton" id="mobileNumberField">Add another</span></a>
					</li>
				</ul>
				<ul class=" mB10 clearfix ">
					<li class="col_6  pR0">
