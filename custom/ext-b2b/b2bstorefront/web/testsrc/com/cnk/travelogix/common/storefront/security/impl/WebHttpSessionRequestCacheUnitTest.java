...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/b2bstorefront/electronics/en",
						"https://electronics.local:9002/b2bstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/b2bstorefront/electronics/en",
						"https://electronics.local:9002/b2bstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/b2bstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/b2bstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/b2bstorefront/electronics/en",
						"https://electronics.local:9002/b2bstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/b2bstorefront",
						"https://electronics.local:9002/b2bstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/b2bstorefront",
						"https://electronics.local:9002/b2bstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/b2bstorefront/electronics/en",
						"https://electronics.local:9002/b2bstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
