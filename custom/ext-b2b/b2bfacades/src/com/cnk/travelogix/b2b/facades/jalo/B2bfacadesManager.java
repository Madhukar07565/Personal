 ...
 */
package com.cnk.travelogix.b2b.facades.jalo;
...
import com.cnk.travelogix.b2b.facades.constants.B2bfacadesConstants;



/**
 * This is the extension manager of the B2bfacades extension.
 */
public class B2bfacadesManager extends GeneratedB2bfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(B2bfacadesManager.class.getName());
	 ...
	 */
	public static B2bfacadesManager getInstance()
	{
		return (B2bfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				B2bfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public B2bfacadesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of B2bfacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of B2bfacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of B2bfacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
