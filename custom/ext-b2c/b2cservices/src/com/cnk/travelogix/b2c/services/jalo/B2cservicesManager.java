...
/**
 * This is the extension manager of the B2cservices extension.
 */
public class B2cservicesManager extends GeneratedB2cservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(B2cservicesManager.class.getName());
	 ...
	 */
	public static B2cservicesManager getInstance()
	{
		return (B2cservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				B2cservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public B2cservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of B2cservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of B2cservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of B2cservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
