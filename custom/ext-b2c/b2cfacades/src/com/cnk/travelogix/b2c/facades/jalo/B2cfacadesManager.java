 ...
 */
package com.cnk.travelogix.b2c.facades.jalo;
...
/**
 * This is the extension manager of the B2cfacades extension.
 */
public class B2cfacadesManager extends GeneratedB2cfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(B2cfacadesManager.class.getName());
	 ...
	 */
	public static B2cfacadesManager getInstance()
	{
		return (B2cfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				B2cfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public B2cfacadesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of B2cfacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of B2cfacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of B2cfacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
