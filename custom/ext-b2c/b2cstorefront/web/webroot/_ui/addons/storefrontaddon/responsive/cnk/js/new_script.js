...
function hideShowAcc(id1, id2)
{
	...
	$('#'+ id2).toggleClass("active");
		if ($('#'+ id2).hasClass('active')) {
			$('#'+ id1).find('img').attr('src','images/up1.png');		   
		}else{
			$('#'+ id1).find('img').attr('src','images/down1.png');
		}
...
function checkThis(hId){
	if(document.getElementById("holiday" + hId).checked == true)
	{
		...
		a.innerHTML = '<div class="fL mR10 mT5 mB5"> <img src="images/common/hotel_thumb.png" alt="Hotel Thumb" /> </div><div class="fL"><div class="fcWht">' + document.getElementById("holidayDest" + hId).innerHTML + '</div><div class="fS11 fcWht">7 Days / 6 Nights</div><div class="fS11 fcWht mB5">Port Blair | Havelock | Neil Island</div><div class="clearfix"><div class="fS22 fW400 fL fcWht"><span class="rupee">Rs</span>86,000</div></div></div>';
		if(compHolidays > 1)
			document.getElementById("compareButton").style.display = "block";
		compHolidays++;
		document.getElementById("compareCount").innerHTML = compHolidays;	
...
function compareHotel(hotelId){
	if(document.getElementById("hotel" + hotelId).checked == true){
		...
		a.innerHTML = '<div class="fL mR10 mT5 mB5"> <img src="images/common/hotel_thumb.png" alt="Hotel Thumb" /> </div><div class="fL"><div class="fcWht">' + document.getElementById("hotelName" + hotelId).innerHTML + '</div><div class="fcWht fS11">4 star</div><div class="clearfix"><div class="fS22 fW400 fL fcWht"><span class="rupee">Rs</span>86,000</div></div></div>';
		if(compHotels > 1)
			document.getElementById("compareButton").style.display = "block";
		compHotels++;
...
function selectFlight(flightLeg,row){
	...
	$("#shoppingCartTab").addClass('sel');
	if(flightLeg == 1){
		document.getElementById("selectFlightLeg1").innerHTML = '<span class="fL mR10"><img src="images/srp_flight/indigo_sml_logo.jpg" class="mB5" alt="Air India Logo" /><span class="fS12 fcWht dB">Multiple <br>airlines</span></span><span class="clearfix fL mTN5 dB"><span class="clearfix dB"><span class="fcWht fL TrvLocation">Mumbai<br /> 11.30</span><span class="flight_icon_sml fL mTB2LR10"></span><span class="fcWht fL TrvLocation">Delhi<br /> 4.35</span></span><span class="fS11 fcWht dB">3h 5m  | 1 stop </span><span class="fS11 fcWht dB">Reaches next day</span><span class="mT5 fR"><img src="images/bin.png" alt="delete" onclick="deleteSelect2(1)" /></span></span>';
		leg1Added = 1;
    ...
    if(flightLeg == 2){
		document.getElementById("selectFlightLeg2").innerHTML = '<span class="fL mR10"><img src="images/srp_flight/indigo_sml_logo.jpg" class="mB5" alt="Air India Logo" /><span class="fS12 fcWht dB">Multiple <br>airlines</span></span><span class="clearfix fL mTN5 dB"><span class="clearfix dB"><span class="fcWht fL TrvLocation">Mumbai<br /> 11.30</span><span class="flight_icon_sml fL mTB2LR10"></span><span class="fcWht fL TrvLocation">Delhi<br /> 4.35</span></span><span class="fS11 fcWht dB">3h 5m  | 1 stop </span><span class="fS11 fcWht dB">Reaches next day</span><span class="mT5 fR"><img src="images/bin.png" alt="delete" onclick="deleteSelect2(2)" /></span></span>';
		leg2Added = 1;
			document.getElementById("selectBooking").style.display = "block";
