...
;(function($) {
    ...
    $.fn.Gridder = function(options) {
        ...
        return this.each(function() {
            ...
            $("body").delegate(".holidayGrayContrInner","click",function(e) {						
						e.preventDefault();
						...
						/*$('html, body').animate({
						  ...
						  if($("#primary_navigation_container").is(':visible')  && $(".portShow").is(':visible') ){
						   $('html, body').animate({
								scrollTop: $(".gridder-show").position().top + $("#primary_navigation_container").height() +  $(".portShow").height() 
							  }, 800);
							} 
					
					     else if( $("#primary_navigation_container").is(':hidden')  && $(".portShow").is(':visible') ){
						   $('html, body').animate({
								scrollTop: $(".gridder-show").position().top +  $(".portShow").height() 
							  }, 800);
							}		
