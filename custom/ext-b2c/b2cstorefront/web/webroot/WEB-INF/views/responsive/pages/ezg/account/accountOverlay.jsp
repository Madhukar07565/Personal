...
<!-- Login container -->
<div class="overlay_content posF" id="loginCont" style="display: none;">
  <div class="login_content_inner">
    ...
    <form>
      ...
      <div class="mB10 clearfix"> <a class="fL mL20 brdrRGrey" href="${fburl}"><span class="facebookLogo fL mR20"></span> </a> <a class="fL mL20" href="javascript:void(0)"> <span class="gmailLogo fR"></span> </a> </div>
...
<!-- Sign up container -->
<div class="overlay_content posF" id="signupContainer" style="display: none;">
  <div class="login_content_inner">
    <div class="closeBtn_popup fR" onclick="popupclose('signupContainer', 'black_overlay')"></div>
    <form>
      <h3 class="mB10 fS18 fW600">Sign up with</h3>
      <div class="mB10 clearfix"> <a class="fL mL20 brdrRGrey" href="javascript:void(0)"><span class="facebookLogo fL mR20"></span> </a> <a class="fL mL20" href="javascript:void(0)"> <span class="gmailLogo fR"></span> </a> </div>
      <p class="tC fW400">or</p>
      <h3 class="mB10 fS18 fW600">Ezeego1</h3>
      <input type="text" placeholder="Enter username" class="w100pcnt mB5">
