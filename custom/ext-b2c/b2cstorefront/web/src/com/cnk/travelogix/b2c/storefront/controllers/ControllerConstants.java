 ...
 *
 */
package com.cnk.travelogix.b2c.storefront.controllers;
...
public interface ControllerConstants
{
	...
	interface Views
	{
		...
		interface Pages
		{
			...
			{
				String AccountLoginPage = "pages/layout/homeLayout2Page"; // NOSONAR
				...
				String AccountRegisterPage = "pages/ezg/account/signupPage"; // NOSONAR
			}
			...
			interface MultiStepCheckout // NOSONAR
			{
				...
				interface Ezeego // NOSONAR
				{
					String BookingSummaryPage = "pages/ezg/cart/bookingSummaryPage";
					String TravelerDetailsPage = "pages/ezg/cart/shoppingCart";
					String UploadDocumentsPage = "pages/ezg/checkout/uploadDocs";
					String TermsAndGuidelinesPage = "pages/ezg/checkout/termsAndGuidelines";
					String CartReviewPage = "pages/ezg/checkout/cartReview";
					String PaymentPage = "pages/ezg/checkout/payment";
					String SilentOrderPostPage = "pages/ezg/checkout/silentOrderPostPage";
					String HostedOrderPostPage = "pages/ezg/checkout/hostedOrderPostPage"; // NOSONAR

					String CART_TRAVELERS = "CART_TRAVELERS"; // NOSONAR
					String CART_UPLOADDOCS = "CART_UPLOADDOCS"; // NOSONAR
					String CART_TERMS = "CART_TERMS"; // NOSONAR
					String CART_REVIEW = "CART_REVIEW"; // NOSONAR
					String CART_PAYMENT = "CART_PAYMENT"; // NOSONAR
				}
			...
			interface Cart // NOSONAR
			{
				...
				String EzgCartPage = "pages/ezg/cart/shoppingCart";
			}
		...
		interface Fragments
		{
			interface Cart // NOSONAR
			{
				...
				String MiniCartFragment = "pages/ezg/panel/minicart";
			}
