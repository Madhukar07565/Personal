 ...
 *
 */
package com.cnk.travelogix.b2c.storefront.controllers.cms;
...
public class GenericCMSComponentController extends AbstractController
{
	...
	@Value("#{configurationService.configuration.getProperty('b2cstorefront.generic.cms.component.controller.authorized.group')}")
