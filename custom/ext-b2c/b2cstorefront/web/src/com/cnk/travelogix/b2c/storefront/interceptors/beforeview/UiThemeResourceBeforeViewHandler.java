 ...
 *
 */
package com.cnk.travelogix.b2c.storefront.interceptors.beforeview;
...
import com.cnk.travelogix.b2c.storefront.util.CSRFTokenManager;
import com.cnk.travelogix.b2c.storefront.web.view.UiExperienceViewResolver;
...
public class UiThemeResourceBeforeViewHandler implements BeforeViewHandler
{
	...
	public void beforeView(final HttpServletRequest request, final HttpServletResponse response, final ModelAndView modelAndView)
	{
		...
		modelAndView.addObject("cnkImagesPath", contextPath + "/_ui/responsive/cnk/images/b2c-images");
		...
		modelAndView.addObject("fullContextPath", request.getContextPath());
