...
public class MiniCartController extends AbstractController
{
	...
	public String getMiniCart1(@PathVariable final String totalDisplay, final Model model)
	{
	...
	public String getMiniCart( final Model model)
	{
		...
		model.addAttribute("cart", cartFacade.getSessionCart());
		return ControllerConstants.Views.Fragments.Cart.MiniCartFragment;
	}
	
	@RequestMapping(value = "/cart/prodCount", method = RequestMethod.GET)
	@RequireHardLogIn
	@ResponseBody
	public String getProdCountInMiniCart() throws ParseException
	{
		final CartData cartData = cartFacade.getMiniCart();
		//model.addAttribute("miniCartData", cartData);
		return Integer.toString(cartData.getTotalUnitCount());
	}
