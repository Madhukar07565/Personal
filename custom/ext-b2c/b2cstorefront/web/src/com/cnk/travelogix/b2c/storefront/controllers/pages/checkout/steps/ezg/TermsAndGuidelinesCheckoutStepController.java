 ...
 */
@Controller
@RequestMapping(value = "/checkout/multi/terms")
public class TermsAndGuidelinesCheckoutStepController extends AbstractCheckoutStepController
{
	private static final String TERMS_AND_GUIDELINES = "terms-and-guidelines";
	...
	@PreValidateCheckoutStep(checkoutStep = TERMS_AND_GUIDELINES)
	@RequireHardLogIn
			...
			CommerceCartModificationException
	{
		...
		model.addAttribute("section", ControllerConstants.Views.Pages.MultiStepCheckout.Ezeego.CART_TERMS);
	...
	{
		return getCheckoutStep(TERMS_AND_GUIDELINES);
	}
