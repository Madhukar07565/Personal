...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performCreateTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createItemType(
			"EmployeeRegistrationProcess",
			"StoreFrontProcess",
			com.cnk.travelogix.mdmbackoffice.process.jalo.EmployeeRegistrationProcess.class,
			null,
			false,
			null,
			false
	...
	protected final void performModifyTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		// performModifyTypes
				...
				single_createattr_EmployeeRegistrationProcess_employee();
			

	}

	
	public void single_createattr_EmployeeRegistrationProcess_employee() throws JaloBusinessException
	{
	...
	protected final void performCreateObjects( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		// performCreateObjects
			...
			single_setAttributeProperties_EmployeeRegistrationProcess_employee();
		
	}


		
						public void single_setAttributeProperties_EmployeeRegistrationProcess_employee() throws JaloBusinessException
						{
