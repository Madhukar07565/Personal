 ...
 */
package com.cnk.travelogix.activity.inventory.core.setup;
...
/**
 * System setup class for activityinventorycore extension
 */
@SystemSetup(extension = ActivityinventorycoreConstants.EXTENSIONNAME)
public class ActivityInventoryCoreSystemSetup extends AbstractSystemSetup
{
	...
	protected void importCommonData(final SystemSetupContext context, final String importDirectory)
	{
		...
		importImpexFile(context, importRoot + "/sampledata/inventoryrequest-activity.impex", false);
