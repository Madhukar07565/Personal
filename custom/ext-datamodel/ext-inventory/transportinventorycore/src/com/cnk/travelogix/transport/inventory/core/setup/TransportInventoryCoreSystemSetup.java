 ...
 */
package com.cnk.travelogix.transport.inventory.core.setup;
 ...
 *
 */
@SystemSetup(extension = TransportinventorycoreConstants.EXTENSIONNAME)
public class TransportInventoryCoreSystemSetup extends AbstractSystemSetup
{
	...
	protected void importCommonData(final SystemSetupContext context, final String importDirectory)
	{
		...
		importImpexFile(context, importRoot + "/sampledata/InventoryRequest-Cruise.impex", false);
	}
