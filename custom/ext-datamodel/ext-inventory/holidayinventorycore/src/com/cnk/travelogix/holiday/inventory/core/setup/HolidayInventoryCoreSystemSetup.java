 ...
 */
package com.cnk.travelogix.holiday.inventory.core.setup;
 ...
 *
 */
@SystemSetup(extension = HolidayinventorycoreConstants.EXTENSIONNAME)
public class HolidayInventoryCoreSystemSetup extends AbstractSystemSetup
{
	...
	{
		logInfo(context, "Importing holiday Common Data...");
		final String importRoot = "/" + importDirectory + "/import";
		importImpexFile(context, importRoot + "/sampledata/inventory-request-holiday.impex", false);
	}
