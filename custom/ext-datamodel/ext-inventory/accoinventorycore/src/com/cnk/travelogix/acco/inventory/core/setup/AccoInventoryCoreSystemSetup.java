 ...
 */
package com.cnk.travelogix.acco.inventory.core.setup;
 ...
 *
 */
@SystemSetup(extension = AccoinventorycoreConstants.EXTENSIONNAME)
public class AccoInventoryCoreSystemSetup extends AbstractSystemSetup
{
	...
	protected void importCommonData(final SystemSetupContext context, final String importDirectory)
	{
		...
		importAccoInventorySampleData(context, importDirectory);
	}
	...
	private void importAccoInventorySampleData(final SystemSetupContext context, final String importDirectory)
	{
		logInfo(context, "Importing Common Data...");

		final String importRoot = "/" + importDirectory + "/import";

		logInfo(context, "Importing Validation Contraints for MDMBackoffice from Directory :" + importRoot);

		importImpexFile(context, importRoot + "/sampledata/inventoryrequest-accommodation.impex", false);
		importImpexFile(context, importRoot + "/validation/accoinventorycore-accommodation-constraints.impex", false);
	}
