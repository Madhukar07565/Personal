...
/**
 * This is the extension manager of the Orgstructurecore extension.
 */
public class OrgstructurecoreManager extends GeneratedOrgstructurecoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(OrgstructurecoreManager.class.getName());
	 ...
	 */
	public static OrgstructurecoreManager getInstance()
	{
		return (OrgstructurecoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(OrgstructurecoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public OrgstructurecoreManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of OrgstructurecoreManager called.");
		}
	}
