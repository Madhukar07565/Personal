...
/**
 * This is the extension manager of the Suppliercredentialscore extension.
 */
public class SuppliercredentialscoreManager extends GeneratedSuppliercredentialscoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SuppliercredentialscoreManager.class.getName());
	 ...
	 */
	public static SuppliercredentialscoreManager getInstance()
	{
		return (SuppliercredentialscoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SuppliercredentialscoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SuppliercredentialscoreManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SuppliercredentialscoreManager called.");
		}
	}
