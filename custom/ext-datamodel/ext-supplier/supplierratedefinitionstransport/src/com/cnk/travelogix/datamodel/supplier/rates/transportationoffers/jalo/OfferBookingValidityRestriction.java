...
public class OfferBookingValidityRestriction extends GeneratedOfferBookingValidityRestriction
{
	@SuppressWarnings("unused")
	private final static Logger LOG = Logger.getLogger(OfferBookingValidityRestriction.class.getName());
