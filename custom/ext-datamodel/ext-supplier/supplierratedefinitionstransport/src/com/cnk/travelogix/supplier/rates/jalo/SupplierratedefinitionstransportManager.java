...
/**
 * This is the extension manager of the Supplierratedefinitionstransport extension.
 */
public class SupplierratedefinitionstransportManager extends GeneratedSupplierratedefinitionstransportManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SupplierratedefinitionstransportManager.class.getName());
	 ...
	 */
	public static SupplierratedefinitionstransportManager getInstance()
	{
		return (SupplierratedefinitionstransportManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SupplierratedefinitionstransportConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SupplierratedefinitionstransportManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SupplierratedefinitionstransportManager called.");
		}
	}
