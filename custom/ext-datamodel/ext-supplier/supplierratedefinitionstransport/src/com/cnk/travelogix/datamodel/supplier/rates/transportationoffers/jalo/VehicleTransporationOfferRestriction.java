...
public class VehicleTransporationOfferRestriction extends GeneratedVehicleTransporationOfferRestriction
{
	@SuppressWarnings("unused")
	private final static Logger LOG = Logger.getLogger(VehicleTransporationOfferRestriction.class.getName());
