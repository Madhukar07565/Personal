...
public class CityTransporationOfferRestriction extends GeneratedCityTransporationOfferRestriction
{
	@SuppressWarnings("unused")
	private final static Logger LOG = Logger.getLogger(CityTransporationOfferRestriction.class.getName());
