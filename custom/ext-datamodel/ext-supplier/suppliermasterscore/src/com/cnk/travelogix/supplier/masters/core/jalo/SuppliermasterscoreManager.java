...
/**
 * This is the extension manager of the Suppliermasterscore extension.
 */
public class SuppliermasterscoreManager extends GeneratedSuppliermasterscoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SuppliermasterscoreManager.class.getName());
	 ...
	 */
	public static SuppliermasterscoreManager getInstance()
	{
		return (SuppliermasterscoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SuppliermasterscoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SuppliermasterscoreManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SuppliermasterscoreManager called.");
		}
	}
