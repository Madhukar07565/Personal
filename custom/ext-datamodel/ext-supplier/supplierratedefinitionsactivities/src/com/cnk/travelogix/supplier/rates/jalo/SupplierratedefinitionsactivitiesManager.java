...
/**
 * This is the extension manager of the Supplierratedefinitionsactivities extension.
 */
public class SupplierratedefinitionsactivitiesManager extends GeneratedSupplierratedefinitionsactivitiesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SupplierratedefinitionsactivitiesManager.class.getName());
	 ...
	 */
	public static SupplierratedefinitionsactivitiesManager getInstance()
	{
		return (SupplierratedefinitionsactivitiesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SupplierratedefinitionsactivitiesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SupplierratedefinitionsactivitiesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SupplierratedefinitionsactivitiesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SupplierratedefinitionsactivitiesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SupplierratedefinitionsactivitiesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
