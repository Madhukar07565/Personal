...
/**
 * This is the extension manager of the Suppliercore extension.
 */
public class SuppliercoreManager extends GeneratedSuppliercoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SuppliercoreManager.class.getName());
	 ...
	 */
	public static SuppliercoreManager getInstance()
	{
		return (SuppliercoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SuppliercoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SuppliercoreManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SuppliercoreManager called.");
		}
	}
