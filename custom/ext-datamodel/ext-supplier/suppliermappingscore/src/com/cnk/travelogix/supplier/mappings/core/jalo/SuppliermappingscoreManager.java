...
/**
 * This is the extension manager of the Suppliermappingscore extension.
 */
public class SuppliermappingscoreManager extends GeneratedSuppliermappingscoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SuppliermappingscoreManager.class.getName());
	 ...
	 */
	public static SuppliermappingscoreManager getInstance()
	{
		return (SuppliermappingscoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SuppliermappingscoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SuppliermappingscoreManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SuppliermappingscoreManager called.");
		}
	}
