...
/**
 * This is the extension manager of the Suppliercommercialscore extension.
 */
public class SuppliercommercialscoreManager extends GeneratedSuppliercommercialscoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SuppliercommercialscoreManager.class.getName());
	 ...
	 */
	public static SuppliercommercialscoreManager getInstance()
	{
		return (SuppliercommercialscoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SuppliercommercialscoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SuppliercommercialscoreManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SuppliercommercialscoreManager called.");
		}
	}
