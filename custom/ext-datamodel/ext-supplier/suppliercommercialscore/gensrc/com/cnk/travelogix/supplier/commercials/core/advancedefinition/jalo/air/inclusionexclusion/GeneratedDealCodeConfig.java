...
/**
 * Generated class for type {@link com.cnk.travelogix.supplier.commercials.core.advancedefinition.jalo.air.inclusionexclusion.DealCodeConfig DealCodeConfig}.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedDealCodeConfig extends AbstractAdvDefConfig
{
	/** Qualifier of the <code>DealCodeConfig.dealCode</code> attribute **/
	public static final String DEALCODE = "dealCode";
	/** Qualifier of the <code>DealCodeConfig.advanceDefinition</code> attribute **/
	...
	**/
	protected static final BidirectionalOneToManyHandler<GeneratedDealCodeConfig> ADVANCEDEFINITIONHANDLER = new BidirectionalOneToManyHandler<GeneratedDealCodeConfig>(
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>DealCodeConfig.advanceDefinition</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>DealCodeConfig.advanceDefinition</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>DealCodeConfig.dealCode</code> attribute.
	 * @return the dealCode
	 */
	public DealCode getDealCode(final SessionContext ctx)
	{
		return (DealCode)getProperty( ctx, DEALCODE);
	}
	 ...
	 * @return the dealCode
	 */
	public DealCode getDealCode()
	{
		return getDealCode( getSession().getSessionContext() );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>DealCodeConfig.dealCode</code> attribute. 
	 * @param value the dealCode
	 */
	public void setDealCode(final SessionContext ctx, final DealCode value)
	{
	 ...
	 * @param value the dealCode
	 */
	public void setDealCode(final DealCode value)
	{
