...
/**
 * This is the extension manager of the Supplierratedefinitionscruise extension.
 */
public class SupplierratedefinitionscruiseManager extends GeneratedSupplierratedefinitionscruiseManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SupplierratedefinitionscruiseManager.class.getName());
	 ...
	 */
	public static SupplierratedefinitionscruiseManager getInstance()
	{
		return (SupplierratedefinitionscruiseManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SupplierratedefinitionscruiseConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SupplierratedefinitionscruiseManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SupplierratedefinitionscruiseManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SupplierratedefinitionscruiseManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SupplierratedefinitionscruiseManager called, current tenant: " + getTenant().getTenantID());
		}
	}
