 ...
 */
package com.cnk.travelogix.presales.masters.core.setup;
 ...
 *
 */
@SystemSetup(extension = PresalescoreConstants.EXTENSIONNAME)
public class PresalesSystemSetup extends AbstractSystemSetup
{
	...
	protected void importCommonData(final SystemSetupContext context, final String importDirectory)
	{
		...
		importImpexFile(context, importRoot + "/sampledata/presales-checklist.impex", false);
		importImpexFile(context, importRoot + "/sampledata/presales-corporate.impex", false);
	}
