 ...
 */
package com.cnk.travelogix.client.settlementterms.setup;
...
/**
 * System setup class for clientsettlementtermscore extension
 */
@SystemSetup(extension = ClientsettlementtermscoreConstants.EXTENSIONNAME)
public class ClientSettlementTermsSystemSetup extends AbstractSystemSetup
{
	...
	protected void importCommonData(final SystemSetupContext context, final String importDirectory)
	{
		...
		importImpexFile(context, importRoot + "/client-settlementterm.impex", false);
