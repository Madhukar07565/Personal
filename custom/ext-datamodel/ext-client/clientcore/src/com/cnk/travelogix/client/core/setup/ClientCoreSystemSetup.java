 ...
 *
 */
package com.cnk.travelogix.client.core.setup;
 ...
 *
 */
@SystemSetup(extension = ClientcoreConstants.EXTENSIONNAME)
public class ClientCoreSystemSetup extends AbstractSystemSetup
{
	...
	protected void importCommonData(final SystemSetupContext context, final String importDirectory)
	{
		...
		importImpexFile(context, importRoot + "/clientprofile.impex", false);
		importImpexFile(context, importRoot + "/clientcorpprofile.impex", false);
		importImpexFile(context, importRoot + "/travellerprofile.impex", false);
		importImpexFile(context, importRoot + "/corptravelpolicy.impex", false);
	}
