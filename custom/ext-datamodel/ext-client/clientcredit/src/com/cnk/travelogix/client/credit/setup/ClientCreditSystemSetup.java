 ...
 */
package com.cnk.travelogix.client.credit.setup;
...
/**
 * System setup class for clientcredit extension
 */
@SystemSetup(extension = ClientcreditConstants.EXTENSIONNAME)
public class ClientCreditSystemSetup extends AbstractSystemSetup
{
	...
	protected void importCommonData(final SystemSetupContext context, final String importDirectory)
	{
		...
		importImpexFile(context, importRoot + "/sampledata/ClientCreditLimit.impex", false);
