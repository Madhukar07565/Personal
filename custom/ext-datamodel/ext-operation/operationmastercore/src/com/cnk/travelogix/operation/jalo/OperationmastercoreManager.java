...
/**
 * This is the extension manager of the Operationmastercore extension.
 */
public class OperationmastercoreManager extends GeneratedOperationmastercoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(OperationmastercoreManager.class.getName());
	 ...
	 */
	public static OperationmastercoreManager getInstance()
	{
		return (OperationmastercoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				OperationmastercoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public OperationmastercoreManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of OperationmastercoreManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of OperationmastercoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of OperationmastercoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
