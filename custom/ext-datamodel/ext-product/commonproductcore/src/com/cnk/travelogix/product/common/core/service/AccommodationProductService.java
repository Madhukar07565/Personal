 ...
 */
public interface AccommodationProductService
{
	/**
	 * generate Company product Id for Acco Product
	 * 
	 * @param accommodationModel
	 */
	public void generateCompanyProductId(AccommodationModel accommodationModel);
}
