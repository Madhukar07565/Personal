 ...
 */
package com.cnk.travelogix.product.common.core.setup;
 ...
 *
 */
@SystemSetup(extension = CommonproductcoreConstants.EXTENSIONNAME)
public class CommonProductSystem extends AbstractSystemSetup
{
	...
	protected void importCommonData(final SystemSetupContext context, final String importDirectory)
	{
		...
		importImpexFile(context, importRoot + "/essentialdata/commonproductcore-essential-data.impex", false);
	}
