...
/**
 * This is the extension manager of the Operationssecureportaladdon extension.
 */
public class OperationssecureportaladdonManager extends GeneratedOperationssecureportaladdonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(OperationssecureportaladdonManager.class.getName());
	 ...
	 */
	public static OperationssecureportaladdonManager getInstance()
	{
		return (OperationssecureportaladdonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				OperationssecureportaladdonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public OperationssecureportaladdonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of OperationssecureportaladdonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of OperationssecureportaladdonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of OperationssecureportaladdonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
