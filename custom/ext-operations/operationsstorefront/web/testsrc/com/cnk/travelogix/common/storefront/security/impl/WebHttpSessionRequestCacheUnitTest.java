...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/operationsstorefront/electronics/en",
						"https://electronics.local:9002/operationsstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/operationsstorefront/electronics/en",
						"https://electronics.local:9002/operationsstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/operationsstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/operationsstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/operationsstorefront/electronics/en",
						"https://electronics.local:9002/operationsstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/operationsstorefront",
						"https://electronics.local:9002/operationsstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/operationsstorefront",
						"https://electronics.local:9002/operationsstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/operationsstorefront/electronics/en",
						"https://electronics.local:9002/operationsstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
