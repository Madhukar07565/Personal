...
<c:choose>
	...
	<c:otherwise>
		...
		<script type="text/javascript" src="${commonResourcePath}/js/knockout-3.4.0.js"></script>
		<script type="text/javascript" src="${commonResourcePath}/js/knockout-autocomplete.js"></script>
		<script type="text/javascript" src="${commonResourcePath}/js/bootbox.min.js"></script>
		<script type="text/javascript" src="${commonResourcePath}/js/todotake.js"></script>
		<script type="text/javascript" src="${commonResourcePath}/js/acc.cnkUserProfile.js"></script>
		<script type="text/javascript" src="${commonResourcePath}/js/moment.min.js"></script>
		<script type="text/javascript" src="${commonResourcePath}/js/knockout-date-bindings.js"></script>
		
		<%-- bootstrap --%>
		<script type="text/javascript" src="${commonResourcePath}/bootstrap/dist/js/bootstrap.min.js"></script>
		<script type="text/javascript" src="${commonResourcePath}/bootstrap/dist/js/slick.min.js"></script>
	<%-- 	<script type="text/javascript" src="${commonResourcePath}/js/manageBooking.js"></script>  --%>

	<%-- 	<script type="text/javascript" src="${commonResourcePath}/bootstrap/dist/js/jquery.min.js"></script> --%>
		...
		<script type="text/javascript" src="${commonResourcePath}/js/ckil-233179.js"></script>
		<script type="text/javascript" src="${commonResourcePath}/js/searchFitlerBooking.js"></script>
