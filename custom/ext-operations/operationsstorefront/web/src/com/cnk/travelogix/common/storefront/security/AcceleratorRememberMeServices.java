 ...
 *  
 */
package com.cnk.travelogix.common.storefront.security;
...
import com.cnk.travelogix.common.storefront.web.wrappers.RemoveEncodingHttpServletRequestWrapper;
...
public class AcceleratorRememberMeServices extends TokenBasedRememberMeServices
{
	...
	protected Authentication createSuccessfulAuthentication(final HttpServletRequest request, final UserDetails user)
	{
		...
		/*COmmented it for employee login to storefront*/
...
//		}
		/*added it for employee login to storefront changes*/
		
		employeeFacade.loginSuccess();
