...
import com.cnk.travelogix.datamodel.operation.components.model.ToDoListComponentModel;
...
public interface ControllerConstants
{
	...
	interface Actions
	{
		interface Cms // NOSONAR
		{
			...
			String ToDoListComponent = _Prefix + ToDoListComponentModel._TYPECODE + _Suffix; // NOSONAR
			String ToDoDetailComponent = _Prefix + ToDoDetailComponentModel._TYPECODE + _Suffix; // NOSONAR
		}
	}
	...
	interface Views
	{
		...
		interface Pages
		{
			...
			interface ToDoTask // NOSONAR
			{
				String ToDoTaskPage = "pages/todo/toDoPage"; // NOSONAR
				String ToDoTaskDetailPage = "pages/todo/toDoDetailPage"; // NOSONAR
				String ToDoTaskCreatePage = "pages/todo/toDoCreatePage"; // NOSONAR
				String ToDoProductJson = "pages/todo/toDoCreatePage"; // NOSONAR
				String ToDoTaskSnapshotPage = "pages/todo/toDoSnapshotPage"; // NOSONAR
			}
			
			interface Receipt
			{
				String ReceiptPage = "pages/receipt/receiptPage";
				String IssueReceiptPage = "pages/receipt/IssueReceiptPage";
			}
		}
		...
		interface Fragments
		{
			interface ToDoTask // NOSONAR
			{
				String ToDoProductJson = "fragments/todo/toDoProductJson"; // NOSONAR
				String ToDoSubTasksJson = "fragments/todo/toDoSubTasksJson"; // NOSONAR
			}
