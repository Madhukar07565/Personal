 ...
 */
package com.cnk.travelogix.operations.facades.jalo;
...
/**
 * This is the extension manager of the Operationsfacades extension.
 */
public class OperationsfacadesManager extends GeneratedOperationsfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(OperationsfacadesManager.class.getName());
	 ...
	 */
	public static OperationsfacadesManager getInstance()
	{
		return (OperationsfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				OperationsfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public OperationsfacadesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of OperationsfacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of OperationsfacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of OperationsfacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
