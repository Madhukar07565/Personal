 ...
 * de.hybris.platform.commerceservices.converter.Populator; import de.hybris.platform.core.enums.CreditCardType; import
 * de.hybris.platform.core.model.order.payment.CreditCardPaymentInfoModel; import
 * de.hybris.platform.core.model.order.payment.PaymentInfoModel; import
 * de.hybris.platform.servicelayer.dto.converter.ConversionException;
 * 
 * import com.cnk.travelogix.common.core.enums.PaymentModes; import
 * com.cnk.travelogix.common.core.model.CashOnDeliveryPaymentInfoModel;
 * 
 * 
 *//**
  *
  *//*
	  * public class TravelogixPaymentInfoReversePopulator implements Populator<CCPaymentInfoData, PaymentInfoModel> {
	  * 
	  * @Override public void populate(final CCPaymentInfoData source, final PaymentInfoModel target) throws
	  * ConversionException {
	  * 
