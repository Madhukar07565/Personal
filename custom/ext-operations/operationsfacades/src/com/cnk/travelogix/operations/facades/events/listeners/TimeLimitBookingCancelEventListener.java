 ...
 * @author C5244544
 */
public class TimeLimitBookingCancelEventListener extends AbstractAcceleratorSiteEventListener<TimeLimitBookingCancelEvent>
{

	private BusinessProcessService businessProcessService;
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(TimeLimitBookingCancelEventListener.class);

	@Override
	protected void onSiteEvent(final TimeLimitBookingCancelEvent timeLimitBookingEvent)
	{
		final TimeLimitBookingProcessModel timeLimitBookingProcessModel = (TimeLimitBookingProcessModel) getBusinessProcessService()
				.createProcess("TimeLimitBooking -" + timeLimitBookingEvent.getCustomer().getUid() + "-" + System.currentTimeMillis(),
						"timeLimitBookingCancelEmailProcess");
	...
	@Override
	protected SiteChannel getSiteChannelForEvent(final TimeLimitBookingCancelEvent timeLimitBookingEvent)
	{
