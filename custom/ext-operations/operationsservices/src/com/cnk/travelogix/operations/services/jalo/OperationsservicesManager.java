 ...
 */
package com.cnk.travelogix.operations.services.jalo;
...
import com.cnk.travelogix.operations.services.constants.OperationsservicesConstants;



/**
 * This is the extension manager of the Operationsservices extension.
 */
public class OperationsservicesManager extends GeneratedOperationsservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(OperationsservicesManager.class.getName());
	 ...
	 */
	public static OperationsservicesManager getInstance()
	{
		return (OperationsservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				OperationsservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public OperationsservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of OperationsservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of OperationsservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of OperationsservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
